 ...
 * @export
 */
export const TaskSummaryStateEnum = {
    Active: 'active',
    Closed: 'closed'
} as const;
export type TaskSummaryStateEnum = typeof TaskSummaryStateEnum[keyof typeof TaskSummaryStateEnum];
...
export function TaskSummaryFromJSONTyped(json: any, ignoreDiscriminator: boolean): TaskSummary {
    ...
    return {
        ...
        'state': json['state'],
        'closeReason': json['close_reason'] == null ? undefined : json['close_reason'],
