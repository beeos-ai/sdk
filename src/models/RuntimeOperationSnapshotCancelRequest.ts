 ...
 * 
 * @export
 * @interface RuntimeOperationSnapshotCancelRequest
 */
export interface RuntimeOperationSnapshotCancelRequest {
    [key: string]: any | any;
    /**
     * 
     * @type {string}
     * @memberof RuntimeOperationSnapshotCancelRequest
     */
    requestedBy: string;
    /**
     * 
...
/**
 * Check if a given object implements the RuntimeOperationSnapshotCancelRequest interface.
 */
export function instanceOfRuntimeOperationSnapshotCancelRequest(value: object): value is RuntimeOperationSnapshotCancelRequest {
...
export function RuntimeOperationSnapshotCancelRequestFromJSON(json: any): RuntimeOperationSnapshotCancelRequest {
    return RuntimeOperationSnapshotCancelRequestFromJSONTyped(json, false);
}

export function RuntimeOperationSnapshotCancelRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): RuntimeOperationSnapshotCancelRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function RuntimeOperationSnapshotCancelRequestToJSON(json: any): RuntimeOperationSnapshotCancelRequest {
    return RuntimeOperationSnapshotCancelRequestToJSONTyped(json, false);
}

export function RuntimeOperationSnapshotCancelRequestToJSONTyped(value?: RuntimeOperationSnapshotCancelRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
