 ...
 * 
 * @export
 * @interface RuntimeOperationTargetOneOf
 */
export interface RuntimeOperationTargetOneOf {
    [key: string]: any | any;
    /**
     * 
     * @type {string}
     * @memberof RuntimeOperationTargetOneOf
     */
    scope: RuntimeOperationTargetOneOfScopeEnum;
}
 ...
 * @export
 */
export const RuntimeOperationTargetOneOfScopeEnum = {
    Instance: 'instance'
} as const;
export type RuntimeOperationTargetOneOfScopeEnum = typeof RuntimeOperationTargetOneOfScopeEnum[keyof typeof RuntimeOperationTargetOneOfScopeEnum];


/**
 * Check if a given object implements the RuntimeOperationTargetOneOf interface.
 */
export function instanceOfRuntimeOperationTargetOneOf(value: object): value is RuntimeOperationTargetOneOf {
    if (!('scope' in value) || value['scope'] === undefined) return false;
    return true;
}

export function RuntimeOperationTargetOneOfFromJSON(json: any): RuntimeOperationTargetOneOf {
    return RuntimeOperationTargetOneOfFromJSONTyped(json, false);
}

export function RuntimeOperationTargetOneOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): RuntimeOperationTargetOneOf {
    if (json == null) {
        return json;
    }
    return {
...
export function RuntimeOperationTargetOneOfToJSON(json: any): RuntimeOperationTargetOneOf {
    return RuntimeOperationTargetOneOfToJSONTyped(json, false);
}

export function RuntimeOperationTargetOneOfToJSONTyped(value?: RuntimeOperationTargetOneOf | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
