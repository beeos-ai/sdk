 ...
 * 
 * @export
 * @interface ListWebhookDeliveriesResponseAllOfData
 */
export interface ListWebhookDeliveriesResponseAllOfData {
    /**
     * 
     * @type {Array<WebhookDeliveryResponse>}
     * @memberof ListWebhookDeliveriesResponseAllOfData
     */
    deliveries: Array<WebhookDeliveryResponse>;
}

/**
 * Check if a given object implements the ListWebhookDeliveriesResponseAllOfData interface.
 */
export function instanceOfListWebhookDeliveriesResponseAllOfData(value: object): value is ListWebhookDeliveriesResponseAllOfData {
    if (!('deliveries' in value) || value['deliveries'] === undefined) return false;
    return true;
}

export function ListWebhookDeliveriesResponseAllOfDataFromJSON(json: any): ListWebhookDeliveriesResponseAllOfData {
    return ListWebhookDeliveriesResponseAllOfDataFromJSONTyped(json, false);
}

export function ListWebhookDeliveriesResponseAllOfDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListWebhookDeliveriesResponseAllOfData {
    if (json == null) {
        return json;
    }
    return {
        
        'deliveries': ((json['deliveries'] as Array<any>).map(WebhookDeliveryResponseFromJSON)),
    };
}

export function ListWebhookDeliveriesResponseAllOfDataToJSON(json: any): ListWebhookDeliveriesResponseAllOfData {
    return ListWebhookDeliveriesResponseAllOfDataToJSONTyped(json, false);
}

export function ListWebhookDeliveriesResponseAllOfDataToJSONTyped(value?: ListWebhookDeliveriesResponseAllOfData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'deliveries': ((value['deliveries'] as Array<any>).map(WebhookDeliveryResponseToJSON)),
    };
}
