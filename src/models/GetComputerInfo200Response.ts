...
import {
    ControlInfoFromJSON,
    ControlInfoFromJSONTyped,
    ControlInfoToJSON,
    ControlInfoToJSONTyped,
} from './ControlInfo';

/**
 * 
 * @export
 * @interface GetComputerInfo200Response
 */
export interface GetComputerInfo200Response {
    /**
     * 
     * @type {boolean}
     * @memberof GetComputerInfo200Response
     */
    success: GetComputerInfo200ResponseSuccessEnum;
    /**
     * 
     * @type {ControlInfo}
     * @memberof GetComputerInfo200Response
 ...
 * @export
 */
export const GetComputerInfo200ResponseSuccessEnum = {
    True: true
} as const;
export type GetComputerInfo200ResponseSuccessEnum = typeof GetComputerInfo200ResponseSuccessEnum[keyof typeof GetComputerInfo200ResponseSuccessEnum];


/**
 * Check if a given object implements the GetComputerInfo200Response interface.
 */
export function instanceOfGetComputerInfo200Response(value: object): value is GetComputerInfo200Response {
    if (!('success' in value) || value['success'] === undefined) return false;
    return true;
}

export function GetComputerInfo200ResponseFromJSON(json: any): GetComputerInfo200Response {
    return GetComputerInfo200ResponseFromJSONTyped(json, false);
}

export function GetComputerInfo200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetComputerInfo200Response {
    if (json == null) {
        return json;
    }
    return {
        ...
        'data': json['data'] == null ? undefined : ControlInfoFromJSON(json['data']),
    };
}

export function GetComputerInfo200ResponseToJSON(json: any): GetComputerInfo200Response {
    return GetComputerInfo200ResponseToJSONTyped(json, false);
}

export function GetComputerInfo200ResponseToJSONTyped(value?: GetComputerInfo200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': ControlInfoToJSON(value['data']),
    };
}
