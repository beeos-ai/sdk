 ...
 * 
 * @export
 * @interface TaskWebhookResponseAllOfData
 */
export interface TaskWebhookResponseAllOfData {
    /**
     * 
     * @type {string}
     * @memberof TaskWebhookResponseAllOfData
     */
    webhookId: string;
    /**
     * 
    ...
    url: string;
    /**
     * `true` when an HMAC signing secret is configured
...
/**
 * Check if a given object implements the TaskWebhookResponseAllOfData interface.
 */
export function instanceOfTaskWebhookResponseAllOfData(value: object): value is TaskWebhookResponseAllOfData {
...
export function TaskWebhookResponseAllOfDataFromJSON(json: any): TaskWebhookResponseAllOfData {
    return TaskWebhookResponseAllOfDataFromJSONTyped(json, false);
}

export function TaskWebhookResponseAllOfDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): TaskWebhookResponseAllOfData {
    if (json == null) {
        return json;
    }
    return {
...
export function TaskWebhookResponseAllOfDataToJSON(json: any): TaskWebhookResponseAllOfData {
    return TaskWebhookResponseAllOfDataToJSONTyped(json, false);
}

export function TaskWebhookResponseAllOfDataToJSONTyped(value?: TaskWebhookResponseAllOfData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
