 ...
 * 
 * @export
 * @interface TaskResponseAllOfData
 */
export interface TaskResponseAllOfData {
    /**
     * 
     * @type {string}
     * @memberof TaskResponseAllOfData
     */
    taskId: string;
    /**
     * 
    ...
    deadlineAt?: Date;
    /**
     * True when the server's message scan hit its internal
     * cap (1000 messages) before reaching the end of the
     * channel log. The reported `status` / `result` / `error`
     * reflect only the scanned prefix; clients seeing this
     * flag should follow up with `GET /tasks/{id}/events`
     * (SSE) for the authoritative tail. Absent (false) on
     * typical tasks.
     * 
     * @type {boolean}
     * @memberof TaskResponseAllOfData
...
/**
 * Check if a given object implements the TaskResponseAllOfData interface.
 */
export function instanceOfTaskResponseAllOfData(value: object): value is TaskResponseAllOfData {
...
export function TaskResponseAllOfDataFromJSON(json: any): TaskResponseAllOfData {
    return TaskResponseAllOfDataFromJSONTyped(json, false);
}

export function TaskResponseAllOfDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): TaskResponseAllOfData {
    if (json == null) {
        return json;
    }
    return {
...
export function TaskResponseAllOfDataToJSON(json: any): TaskResponseAllOfData {
    return TaskResponseAllOfDataToJSONTyped(json, false);
}

export function TaskResponseAllOfDataToJSONTyped(value?: TaskResponseAllOfData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'deadline_at': value['deadlineAt'] == null ? undefined : ((value['deadlineAt']).toISOString()),
