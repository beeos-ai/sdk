...
import type { ConversationResponseAllOfData } from './ConversationResponseAllOfData';
import {
    ConversationResponseAllOfDataFromJSON,
    ConversationResponseAllOfDataFromJSONTyped,
    ConversationResponseAllOfDataToJSON,
    ConversationResponseAllOfDataToJSONTyped,
} from './ConversationResponseAllOfData';

/**
 * 
 * @export
 * @interface ListConversationsResponseAllOfData
 */
export interface ListConversationsResponseAllOfData {
    /**
     * 
     * @type {Array<ConversationResponseAllOfData>}
     * @memberof ListConversationsResponseAllOfData
     */
    conversations: Array<ConversationResponseAllOfData>;
    /**
     * Pagination cursor. Empty when the caller has reached the
     * end of results.
     * 
     * @type {string}
     * @memberof ListConversationsResponseAllOfData
...
/**
 * Check if a given object implements the ListConversationsResponseAllOfData interface.
 */
export function instanceOfListConversationsResponseAllOfData(value: object): value is ListConversationsResponseAllOfData {
    if (!('conversations' in value) || value['conversations'] === undefined) return false;
    return true;
}

export function ListConversationsResponseAllOfDataFromJSON(json: any): ListConversationsResponseAllOfData {
    return ListConversationsResponseAllOfDataFromJSONTyped(json, false);
}

export function ListConversationsResponseAllOfDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListConversationsResponseAllOfData {
    if (json == null) {
        return json;
    }
    return {
        
        'conversations': ((json['conversations'] as Array<any>).map(ConversationResponseAllOfDataFromJSON)),
        'nextSince': json['next_since'] == null ? undefined : json['next_since'],
    };
}

export function ListConversationsResponseAllOfDataToJSON(json: any): ListConversationsResponseAllOfData {
    return ListConversationsResponseAllOfDataToJSONTyped(json, false);
}

export function ListConversationsResponseAllOfDataToJSONTyped(value?: ListConversationsResponseAllOfData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'conversations': ((value['conversations'] as Array<any>).map(ConversationResponseAllOfDataToJSON)),
        'next_since': value['nextSince'],
    };
}
