...
import {
    ...
    ActionResultFromJSONTyped,
    ActionResultToJSON,
    ActionResultToJSONTyped,
} from './ActionResult';
...
export interface InlineObject {
     ...
     */
    success: InlineObjectSuccessEnum;
    /**
     * 
     * @type {ActionResult}
     * @memberof InlineObject
 ...
 * @export
 */
export const InlineObjectSuccessEnum = {
    True: true
} as const;
export type InlineObjectSuccessEnum = typeof InlineObjectSuccessEnum[keyof typeof InlineObjectSuccessEnum];
...
export function InlineObjectFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineObject {
    ...
    return {
        ...
        'data': ActionResultFromJSON(json['data']),
    };
}
...
export function InlineObjectToJSONTyped(value?: InlineObject | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'data': ActionResultToJSON(value['data']),
    };
}
