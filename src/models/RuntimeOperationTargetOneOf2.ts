 ...
 * 
 * @export
 * @interface RuntimeOperationTargetOneOf2
 */
export interface RuntimeOperationTargetOneOf2 {
    [key: string]: any | any;
    /**
     * 
     * @type {string}
     * @memberof RuntimeOperationTargetOneOf2
     */
    scope: RuntimeOperationTargetOneOf2ScopeEnum;
    /**
     * 
     * @type {string}
     * @memberof RuntimeOperationTargetOneOf2
 ...
 * @export
 */
export const RuntimeOperationTargetOneOf2ScopeEnum = {
    Conversation: 'conversation'
} as const;
export type RuntimeOperationTargetOneOf2ScopeEnum = typeof RuntimeOperationTargetOneOf2ScopeEnum[keyof typeof RuntimeOperationTargetOneOf2ScopeEnum];


/**
 * Check if a given object implements the RuntimeOperationTargetOneOf2 interface.
 */
export function instanceOfRuntimeOperationTargetOneOf2(value: object): value is RuntimeOperationTargetOneOf2 {
...
export function RuntimeOperationTargetOneOf2FromJSON(json: any): RuntimeOperationTargetOneOf2 {
    return RuntimeOperationTargetOneOf2FromJSONTyped(json, false);
}

export function RuntimeOperationTargetOneOf2FromJSONTyped(json: any, ignoreDiscriminator: boolean): RuntimeOperationTargetOneOf2 {
    if (json == null) {
        return json;
    }
    return {
...
export function RuntimeOperationTargetOneOf2ToJSON(json: any): RuntimeOperationTargetOneOf2 {
    return RuntimeOperationTargetOneOf2ToJSONTyped(json, false);
}

export function RuntimeOperationTargetOneOf2ToJSONTyped(value?: RuntimeOperationTargetOneOf2 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
