 ...
 * 
 * @export
 * @interface CancelConversation202ResponseData
 */
export interface CancelConversation202ResponseData {
    [key: string]: any | any;
    /**
     * 
     * @type {string}
     * @memberof CancelConversation202ResponseData
     */
    operationId: string;
    /**
     * 
...
/**
 * Check if a given object implements the CancelConversation202ResponseData interface.
 */
export function instanceOfCancelConversation202ResponseData(value: object): value is CancelConversation202ResponseData {
    if (!('operationId' in value) || value['operationId'] === undefined) return false;
    if (!('status' in value) || value['status'] === undefined) return false;
    return true;
}

export function CancelConversation202ResponseDataFromJSON(json: any): CancelConversation202ResponseData {
    return CancelConversation202ResponseDataFromJSONTyped(json, false);
}

export function CancelConversation202ResponseDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): CancelConversation202ResponseData {
    if (json == null) {
        return json;
    }
    return {
...
export function CancelConversation202ResponseDataToJSON(json: any): CancelConversation202ResponseData {
    return CancelConversation202ResponseDataToJSONTyped(json, false);
}

export function CancelConversation202ResponseDataToJSONTyped(value?: CancelConversation202ResponseData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
