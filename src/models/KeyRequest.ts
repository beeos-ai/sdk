...
export interface KeyRequest {
    /**
     * Key name(s). One key = a key press; multiple keys = a hotkey
     * combo (desktop). Mobile callers pass a single Android KeyCode.
     * 
     * @type {Array<string>}
     * @memberof KeyRequest
     */
 ...
 */
export function instanceOfKeyRequest(value: object): value is KeyRequest {
...
export function KeyRequestToJSON(json: any): KeyRequest {
    return KeyRequestToJSONTyped(json, false);
}

export function KeyRequestToJSONTyped(value?: KeyRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
