...
export interface FileMetaResponse {
    ...
    size?: number;
    /**
     * Presigned GET URL (24h default TTL on S3). Agents receive the
     * same URL when the file is attached to an invoke / task envelope.
     * 
     * @type {string}
     * @memberof FileMetaResponse
     */
...
/**
 * Check if a given object implements the FileMetaResponse interface.
 */
export function instanceOfFileMetaResponse(value: object): value is FileMetaResponse {
    if (!('fileId' in value) || value['fileId'] === undefined) return false;
    return true;
}

export function FileMetaResponseFromJSON(json: any): FileMetaResponse {
    return FileMetaResponseFromJSONTyped(json, false);
}

export function FileMetaResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): FileMetaResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function FileMetaResponseToJSON(json: any): FileMetaResponse {
    return FileMetaResponseToJSONTyped(json, false);
}

export function FileMetaResponseToJSONTyped(value?: FileMetaResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
