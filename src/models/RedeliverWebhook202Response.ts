...
import {
    ...
    WebhookDeliveryResponseFromJSONTyped,
    WebhookDeliveryResponseToJSON,
    WebhookDeliveryResponseToJSONTyped,
} from './WebhookDeliveryResponse';

/**
 * 
 * @export
 * @interface RedeliverWebhook202Response
 */
export interface RedeliverWebhook202Response {
    /**
     * 
     * @type {boolean}
     * @memberof RedeliverWebhook202Response
     */
    success: RedeliverWebhook202ResponseSuccessEnum;
    /**
     * 
 ...
 * @export
 */
export const RedeliverWebhook202ResponseSuccessEnum = {
    True: true
} as const;
export type RedeliverWebhook202ResponseSuccessEnum = typeof RedeliverWebhook202ResponseSuccessEnum[keyof typeof RedeliverWebhook202ResponseSuccessEnum];


/**
 * Check if a given object implements the RedeliverWebhook202Response interface.
 */
export function instanceOfRedeliverWebhook202Response(value: object): value is RedeliverWebhook202Response {
    if (!('success' in value) || value['success'] === undefined) return false;
    if (!('data' in value) || value['data'] === undefined) return false;
    return true;
}

export function RedeliverWebhook202ResponseFromJSON(json: any): RedeliverWebhook202Response {
    return RedeliverWebhook202ResponseFromJSONTyped(json, false);
}

export function RedeliverWebhook202ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): RedeliverWebhook202Response {
    if (json == null) {
        return json;
    }
    return {
        ...
        'data': WebhookDeliveryResponseFromJSON(json['data']),
    };
}

export function RedeliverWebhook202ResponseToJSON(json: any): RedeliverWebhook202Response {
    return RedeliverWebhook202ResponseToJSONTyped(json, false);
}

export function RedeliverWebhook202ResponseToJSONTyped(value?: RedeliverWebhook202Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': WebhookDeliveryResponseToJSON(value['data']),
    };
}
