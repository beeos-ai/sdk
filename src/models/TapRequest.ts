...
/**
 * Check if a given object implements the TapRequest interface.
 */
export function instanceOfTapRequest(value: object): value is TapRequest {
    if (!('x' in value) || value['x'] === undefined) return false;
    if (!('y' in value) || value['y'] === undefined) return false;
    return true;
}

export function TapRequestFromJSON(json: any): TapRequest {
    return TapRequestFromJSONTyped(json, false);
}

export function TapRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): TapRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function TapRequestToJSON(json: any): TapRequest {
    return TapRequestToJSONTyped(json, false);
}

export function TapRequestToJSONTyped(value?: TapRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
