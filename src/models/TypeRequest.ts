...
/**
 * Check if a given object implements the TypeRequest interface.
 */
export function instanceOfTypeRequest(value: object): value is TypeRequest {
    if (!('text' in value) || value['text'] === undefined) return false;
    return true;
}

export function TypeRequestFromJSON(json: any): TypeRequest {
    return TypeRequestFromJSONTyped(json, false);
}

export function TypeRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): TypeRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function TypeRequestToJSON(json: any): TypeRequest {
    return TypeRequestToJSONTyped(json, false);
}

export function TypeRequestToJSONTyped(value?: TypeRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
