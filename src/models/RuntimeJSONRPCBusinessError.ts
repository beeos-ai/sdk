...
import type { RuntimeJSONRPCBusinessErrorError } from './RuntimeJSONRPCBusinessErrorError';
import {
    RuntimeJSONRPCBusinessErrorErrorFromJSON,
    RuntimeJSONRPCBusinessErrorErrorFromJSONTyped,
    RuntimeJSONRPCBusinessErrorErrorToJSON,
    RuntimeJSONRPCBusinessErrorErrorToJSONTyped,
} from './RuntimeJSONRPCBusinessErrorError';

/**
 * 
 * @export
 * @interface RuntimeJSONRPCBusinessError
 */
export interface RuntimeJSONRPCBusinessError {
    [key: string]: any | any;
    /**
     * 
     * @type {any}
     * @memberof RuntimeJSONRPCBusinessError
     */
    jsonrpc: any | null;
    /**
     * 
    ...
    /**
     * 
     * @type {RuntimeJSONRPCBusinessErrorError}
     * @memberof RuntimeJSONRPCBusinessError
     */
...
/**
 * Check if a given object implements the RuntimeJSONRPCBusinessError interface.
 */
export function instanceOfRuntimeJSONRPCBusinessError(value: object): value is RuntimeJSONRPCBusinessError {
...
export function RuntimeJSONRPCBusinessErrorFromJSON(json: any): RuntimeJSONRPCBusinessError {
    return RuntimeJSONRPCBusinessErrorFromJSONTyped(json, false);
}

export function RuntimeJSONRPCBusinessErrorFromJSONTyped(json: any, ignoreDiscriminator: boolean): RuntimeJSONRPCBusinessError {
    if (json == null) {
        return json;
    }
    return {
        ...
        'id': json['id'],
        'error': RuntimeJSONRPCBusinessErrorErrorFromJSON(json['error']),
    };
}

export function RuntimeJSONRPCBusinessErrorToJSON(json: any): RuntimeJSONRPCBusinessError {
    return RuntimeJSONRPCBusinessErrorToJSONTyped(json, false);
}

export function RuntimeJSONRPCBusinessErrorToJSONTyped(value?: RuntimeJSONRPCBusinessError | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'id': value['id'],
        'error': RuntimeJSONRPCBusinessErrorErrorToJSON(value['error']),
    };
}
