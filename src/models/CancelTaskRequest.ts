...
export interface CancelTaskRequest {
    /**
     * Free-form caller label propagated on the `chat_cancel` envelope
     * payload so the agent can audit-log why its turn was aborted.
     * Empty defaults to `canceled`.
     * 
     * @type {string}
...
/**
 * Check if a given object implements the CancelTaskRequest interface.
 */
export function instanceOfCancelTaskRequest(value: object): value is CancelTaskRequest {
    return true;
}

export function CancelTaskRequestFromJSON(json: any): CancelTaskRequest {
    return CancelTaskRequestFromJSONTyped(json, false);
}

export function CancelTaskRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CancelTaskRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function CancelTaskRequestToJSON(json: any): CancelTaskRequest {
    return CancelTaskRequestToJSONTyped(json, false);
}

export function CancelTaskRequestToJSONTyped(value?: CancelTaskRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
