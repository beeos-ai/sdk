 ...
 * 
 * @export
 * @interface RuntimeOperationSnapshotProgress
 */
export interface RuntimeOperationSnapshotProgress {
    [key: string]: any | any;
    /**
     * 
     * @type {string}
     * @memberof RuntimeOperationSnapshotProgress
     */
    sequence: string;
    /**
     * 
...
/**
 * Check if a given object implements the RuntimeOperationSnapshotProgress interface.
 */
export function instanceOfRuntimeOperationSnapshotProgress(value: object): value is RuntimeOperationSnapshotProgress {
    if (!('sequence' in value) || value['sequence'] === undefined) return false;
    if (!('phase' in value) || value['phase'] === undefined) return false;
    return true;
}

export function RuntimeOperationSnapshotProgressFromJSON(json: any): RuntimeOperationSnapshotProgress {
    return RuntimeOperationSnapshotProgressFromJSONTyped(json, false);
}

export function RuntimeOperationSnapshotProgressFromJSONTyped(json: any, ignoreDiscriminator: boolean): RuntimeOperationSnapshotProgress {
    if (json == null) {
        return json;
    }
    return {
...
export function RuntimeOperationSnapshotProgressToJSON(json: any): RuntimeOperationSnapshotProgress {
    return RuntimeOperationSnapshotProgressToJSONTyped(json, false);
}

export function RuntimeOperationSnapshotProgressToJSONTyped(value?: RuntimeOperationSnapshotProgress | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
