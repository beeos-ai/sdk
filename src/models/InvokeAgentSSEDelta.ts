 ...
 * 
 * @export
 * @interface InvokeAgentSSEDelta
 */
export interface InvokeAgentSSEDelta {
    /**
     * 
     * @type {string}
     * @memberof InvokeAgentSSEDelta
     */
    type: InvokeAgentSSEDeltaTypeEnum;
    /**
 ...
 * @export
 */
export const InvokeAgentSSEDeltaTypeEnum = {
    Delta: 'delta'
} as const;
export type InvokeAgentSSEDeltaTypeEnum = typeof InvokeAgentSSEDeltaTypeEnum[keyof typeof InvokeAgentSSEDeltaTypeEnum];


/**
 * Check if a given object implements the InvokeAgentSSEDelta interface.
 */
export function instanceOfInvokeAgentSSEDelta(value: object): value is InvokeAgentSSEDelta {
    if (!('type' in value) || value['type'] === undefined) return false;
    if (!('text' in value) || value['text'] === undefined) return false;
    return true;
}

export function InvokeAgentSSEDeltaFromJSON(json: any): InvokeAgentSSEDelta {
    return InvokeAgentSSEDeltaFromJSONTyped(json, false);
}

export function InvokeAgentSSEDeltaFromJSONTyped(json: any, ignoreDiscriminator: boolean): InvokeAgentSSEDelta {
    if (json == null) {
        return json;
    }
    return {
...
export function InvokeAgentSSEDeltaToJSON(json: any): InvokeAgentSSEDelta {
    return InvokeAgentSSEDeltaToJSONTyped(json, false);
}

export function InvokeAgentSSEDeltaToJSONTyped(value?: InvokeAgentSSEDelta | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
