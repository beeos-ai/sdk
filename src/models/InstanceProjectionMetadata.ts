 ...
 * @export
 * @interface InstanceProjectionMetadata
 */
export interface InstanceProjectionMetadata {
    /**
     * 
     * @type {string}
     * @memberof InstanceProjectionMetadata
     */
     ...
     * @memberof InstanceProjectionMetadata
     */
    syncState: InstanceProjectionMetadataSyncStateEnum;
    /**
     * 
     * @type {boolean}
     * @memberof InstanceProjectionMetadata
 ...
 * @export
 */
export const InstanceProjectionMetadataSyncStateEnum = {
    Synced: 'synced'
} as const;
export type InstanceProjectionMetadataSyncStateEnum = typeof InstanceProjectionMetadataSyncStateEnum[keyof typeof InstanceProjectionMetadataSyncStateEnum];


/**
 * Check if a given object implements the InstanceProjectionMetadata interface.
 */
export function instanceOfInstanceProjectionMetadata(value: object): value is InstanceProjectionMetadata {
    if (!('acceptedEpoch' in value) || value['acceptedEpoch'] === undefined) return false;
    if (!('acceptedRevision' in value) || value['acceptedRevision'] === undefined) return false;
    if (!('canonicalHash' in value) || value['canonicalHash'] === undefined) return false;
    if (!('lastSyncedAt' in value) || value['lastSyncedAt'] === undefined) return false;
    if (!('syncState' in value) || value['syncState'] === undefined) return false;
    if (!('agentsComplete' in value) || value['agentsComplete'] === undefined) return false;
    if (!('skillsComplete' in value) || value['skillsComplete'] === undefined) return false;
    return true;
}

export function InstanceProjectionMetadataFromJSON(json: any): InstanceProjectionMetadata {
    return InstanceProjectionMetadataFromJSONTyped(json, false);
}

export function InstanceProjectionMetadataFromJSONTyped(json: any, ignoreDiscriminator: boolean): InstanceProjectionMetadata {
    if (json == null) {
        return json;
    }
    return {
        
        'acceptedEpoch': json['acceptedEpoch'],
        'acceptedRevision': json['acceptedRevision'],
        'canonicalHash': json['canonicalHash'],
        'lastSyncedAt': (new Date(json['lastSyncedAt'])),
        'syncState': json['syncState'],
        'agentsComplete': json['agentsComplete'],
        'skillsComplete': json['skillsComplete'],
    };
}

export function InstanceProjectionMetadataToJSON(json: any): InstanceProjectionMetadata {
    return InstanceProjectionMetadataToJSONTyped(json, false);
}

export function InstanceProjectionMetadataToJSONTyped(value?: InstanceProjectionMetadata | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'agentsComplete': value['agentsComplete'],
        'skillsComplete': value['skillsComplete'],
    };
}
