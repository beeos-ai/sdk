...
export interface PressButtonRequest {
    /**
     * Hardware / nav button name (`back` / `home` / `recent` /
     * `power` / `volume_up` / `volume_down` / `enter`).
     * 
     * @type {string}
     * @memberof PressButtonRequest
     */
    button: string;
}

/**
 * Check if a given object implements the PressButtonRequest interface.
 */
export function instanceOfPressButtonRequest(value: object): value is PressButtonRequest {
    if (!('button' in value) || value['button'] === undefined) return false;
    return true;
}

export function PressButtonRequestFromJSON(json: any): PressButtonRequest {
    return PressButtonRequestFromJSONTyped(json, false);
}

export function PressButtonRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PressButtonRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function PressButtonRequestToJSON(json: any): PressButtonRequest {
    return PressButtonRequestToJSONTyped(json, false);
}

export function PressButtonRequestToJSONTyped(value?: PressButtonRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
