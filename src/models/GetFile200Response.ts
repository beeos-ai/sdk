...
import type { FileMetaResponse } from './FileMetaResponse';
import {
    FileMetaResponseFromJSON,
    FileMetaResponseFromJSONTyped,
    FileMetaResponseToJSON,
    FileMetaResponseToJSONTyped,
} from './FileMetaResponse';
...
export interface GetFile200Response {
     ...
     */
    success: GetFile200ResponseSuccessEnum;
    /**
     * 
 ...
 * @export
 */
export const GetFile200ResponseSuccessEnum = {
    True: true
} as const;
export type GetFile200ResponseSuccessEnum = typeof GetFile200ResponseSuccessEnum[keyof typeof GetFile200ResponseSuccessEnum];


/**
 * Check if a given object implements the GetFile200Response interface.
 */
export function instanceOfGetFile200Response(value: object): value is GetFile200Response {
    if (!('success' in value) || value['success'] === undefined) return false;
    return true;
}

export function GetFile200ResponseFromJSON(json: any): GetFile200Response {
    return GetFile200ResponseFromJSONTyped(json, false);
}

export function GetFile200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetFile200Response {
    if (json == null) {
        return json;
    }
    return {
        ...
        'data': json['data'] == null ? undefined : FileMetaResponseFromJSON(json['data']),
    };
}

export function GetFile200ResponseToJSON(json: any): GetFile200Response {
    return GetFile200ResponseToJSONTyped(json, false);
}

export function GetFile200ResponseToJSONTyped(value?: GetFile200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': FileMetaResponseToJSON(value['data']),
    };
}
