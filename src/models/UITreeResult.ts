...
/**
 * Check if a given object implements the UITreeResult interface.
 */
export function instanceOfUITreeResult(value: object): value is UITreeResult {
    if (!('supported' in value) || value['supported'] === undefined) return false;
    if (!('content' in value) || value['content'] === undefined) return false;
    return true;
}

export function UITreeResultFromJSON(json: any): UITreeResult {
    return UITreeResultFromJSONTyped(json, false);
}

export function UITreeResultFromJSONTyped(json: any, ignoreDiscriminator: boolean): UITreeResult {
    if (json == null) {
        return json;
    }
    return {
...
export function UITreeResultToJSON(json: any): UITreeResult {
    return UITreeResultToJSONTyped(json, false);
}

export function UITreeResultToJSONTyped(value?: UITreeResult | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
