 ...
 * 
 * @export
 * @interface ServiceOperationCancelConflict
 */
export interface ServiceOperationCancelConflict {
    [key: string]: any | any;
    /**
     * 
     * @type {any}
     * @memberof ServiceOperationCancelConflict
     */
    code: any | null;
    /**
     * 
...
/**
 * Check if a given object implements the ServiceOperationCancelConflict interface.
 */
export function instanceOfServiceOperationCancelConflict(value: object): value is ServiceOperationCancelConflict {
...
export function ServiceOperationCancelConflictFromJSON(json: any): ServiceOperationCancelConflict {
    return ServiceOperationCancelConflictFromJSONTyped(json, false);
}

export function ServiceOperationCancelConflictFromJSONTyped(json: any, ignoreDiscriminator: boolean): ServiceOperationCancelConflict {
    if (json == null) {
        return json;
    }
    return {
...
export function ServiceOperationCancelConflictToJSON(json: any): ServiceOperationCancelConflict {
    return ServiceOperationCancelConflictToJSONTyped(json, false);
}

export function ServiceOperationCancelConflictToJSONTyped(value?: ServiceOperationCancelConflict | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
