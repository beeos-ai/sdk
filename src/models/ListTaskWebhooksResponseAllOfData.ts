...
import type { ListTaskWebhooksResponseAllOfDataWebhooks } from './ListTaskWebhooksResponseAllOfDataWebhooks';
import {
    ListTaskWebhooksResponseAllOfDataWebhooksFromJSON,
    ListTaskWebhooksResponseAllOfDataWebhooksFromJSONTyped,
    ListTaskWebhooksResponseAllOfDataWebhooksToJSON,
    ListTaskWebhooksResponseAllOfDataWebhooksToJSONTyped,
} from './ListTaskWebhooksResponseAllOfDataWebhooks';

/**
 * 
 * @export
 * @interface ListTaskWebhooksResponseAllOfData
 */
export interface ListTaskWebhooksResponseAllOfData {
    /**
     * 
     * @type {Array<ListTaskWebhooksResponseAllOfDataWebhooks>}
     * @memberof ListTaskWebhooksResponseAllOfData
     */
    webhooks: Array<ListTaskWebhooksResponseAllOfDataWebhooks>;
}

/**
 * Check if a given object implements the ListTaskWebhooksResponseAllOfData interface.
 */
export function instanceOfListTaskWebhooksResponseAllOfData(value: object): value is ListTaskWebhooksResponseAllOfData {
    if (!('webhooks' in value) || value['webhooks'] === undefined) return false;
    return true;
}

export function ListTaskWebhooksResponseAllOfDataFromJSON(json: any): ListTaskWebhooksResponseAllOfData {
    return ListTaskWebhooksResponseAllOfDataFromJSONTyped(json, false);
}

export function ListTaskWebhooksResponseAllOfDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListTaskWebhooksResponseAllOfData {
    if (json == null) {
        return json;
    }
    return {
        
        'webhooks': ((json['webhooks'] as Array<any>).map(ListTaskWebhooksResponseAllOfDataWebhooksFromJSON)),
    };
}

export function ListTaskWebhooksResponseAllOfDataToJSON(json: any): ListTaskWebhooksResponseAllOfData {
    return ListTaskWebhooksResponseAllOfDataToJSONTyped(json, false);
}

export function ListTaskWebhooksResponseAllOfDataToJSONTyped(value?: ListTaskWebhooksResponseAllOfData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'webhooks': ((value['webhooks'] as Array<any>).map(ListTaskWebhooksResponseAllOfDataWebhooksToJSON)),
    };
}
