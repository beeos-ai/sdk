...
/**
 * Check if a given object implements the SwipeRequest interface.
 */
export function instanceOfSwipeRequest(value: object): value is SwipeRequest {
...
export function SwipeRequestFromJSON(json: any): SwipeRequest {
    return SwipeRequestFromJSONTyped(json, false);
}

export function SwipeRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): SwipeRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function SwipeRequestToJSON(json: any): SwipeRequest {
    return SwipeRequestToJSONTyped(json, false);
}

export function SwipeRequestToJSONTyped(value?: SwipeRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
