...
/**
 * Check if a given object implements the RenameConversationRequest interface.
 */
export function instanceOfRenameConversationRequest(value: object): value is RenameConversationRequest {
    if (!('title' in value) || value['title'] === undefined) return false;
    return true;
}

export function RenameConversationRequestFromJSON(json: any): RenameConversationRequest {
    return RenameConversationRequestFromJSONTyped(json, false);
}

export function RenameConversationRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): RenameConversationRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function RenameConversationRequestToJSON(json: any): RenameConversationRequest {
    return RenameConversationRequestToJSONTyped(json, false);
}

export function RenameConversationRequestToJSONTyped(value?: RenameConversationRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
