 ...
 * @export
 */
export const ServiceRuntimeMethod = {
    SessionSetMode: 'session/set_mode',
    AgentCreate: 'agent/create',
    AgentUpdate: 'agent/update',
    AgentDelete: 'agent/delete',
    AgentApplyTemplate: 'agent/applyTemplate',
...
export type ServiceRuntimeMethod = typeof ServiceRuntimeMethod[keyof typeof ServiceRuntimeMethod];


export function instanceOfServiceRuntimeMethod(value: any): boolean {
    for (const key in ServiceRuntimeMethod) {
        if (Object.prototype.hasOwnProperty.call(ServiceRuntimeMethod, key)) {
            if (ServiceRuntimeMethod[key as keyof typeof ServiceRuntimeMethod] === value) {
                return true;
            }
        }
    }
...
export function ServiceRuntimeMethodFromJSON(json: any): ServiceRuntimeMethod {
    return ServiceRuntimeMethodFromJSONTyped(json, false);
}

export function ServiceRuntimeMethodFromJSONTyped(json: any, ignoreDiscriminator: boolean): ServiceRuntimeMethod {
    return json as ServiceRuntimeMethod;
}

export function ServiceRuntimeMethodToJSON(value?: ServiceRuntimeMethod | null): any {
    return value as any;
}

export function ServiceRuntimeMethodToJSONTyped(value: any, ignoreDiscriminator: boolean): ServiceRuntimeMethod {
    return value as ServiceRuntimeMethod;
}
