 ...
 * 
 * @export
 * @interface RuntimeOperationSnapshotProjection
 */
export interface RuntimeOperationSnapshotProjection {
    [key: string]: any | any;
    /**
     * 
     * @type {string}
     * @memberof RuntimeOperationSnapshotProjection
     */
    revision: string;
    /**
     * 
     ...
     * @memberof RuntimeOperationSnapshotProjection
     */
    state: RuntimeOperationSnapshotProjectionStateEnum;
    /**
     * 
     * @type {string}
     * @memberof RuntimeOperationSnapshotProjection
 ...
 * @export
 */
export const RuntimeOperationSnapshotProjectionStateEnum = {
    NotApplicable: 'not_applicable',
    Pending: 'pending',
    Synced: 'synced',
    Blocked: 'blocked'
} as const;
export type RuntimeOperationSnapshotProjectionStateEnum = typeof RuntimeOperationSnapshotProjectionStateEnum[keyof typeof RuntimeOperationSnapshotProjectionStateEnum];


/**
 * Check if a given object implements the RuntimeOperationSnapshotProjection interface.
 */
export function instanceOfRuntimeOperationSnapshotProjection(value: object): value is RuntimeOperationSnapshotProjection {
    if (!('revision' in value) || value['revision'] === undefined) return false;
    if (!('state' in value) || value['state'] === undefined) return false;
    return true;
}

export function RuntimeOperationSnapshotProjectionFromJSON(json: any): RuntimeOperationSnapshotProjection {
    return RuntimeOperationSnapshotProjectionFromJSONTyped(json, false);
}

export function RuntimeOperationSnapshotProjectionFromJSONTyped(json: any, ignoreDiscriminator: boolean): RuntimeOperationSnapshotProjection {
    if (json == null) {
        return json;
    }
    return {
...
export function RuntimeOperationSnapshotProjectionToJSON(json: any): RuntimeOperationSnapshotProjection {
    return RuntimeOperationSnapshotProjectionToJSONTyped(json, false);
}

export function RuntimeOperationSnapshotProjectionToJSONTyped(value?: RuntimeOperationSnapshotProjection | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
