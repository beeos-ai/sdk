...
/**
 * BYOD (bring-your-own-device) registration / static metadata for an
 * instance's backing device, e.g. a user-provided phone.
 * 
...
export interface DeviceInfoDTO {
    ...
    /**
     * Device hardware / Agent-reported capability strings. Semantically
     * different from `InstanceDataDTO.capabilities` (an instance-level
    ...
    /**
     * Optional caller-/device-supplied extra metadata (raw JSON
     * object). Omitted entirely when absent or malformed.
     * 
     * @type {{ [key: string]: any; }}
     * @memberof DeviceInfoDTO
     */
...
/**
 * Check if a given object implements the DeviceInfoDTO interface.
 */
export function instanceOfDeviceInfoDTO(value: object): value is DeviceInfoDTO {
...
export function DeviceInfoDTOFromJSON(json: any): DeviceInfoDTO {
    return DeviceInfoDTOFromJSONTyped(json, false);
}

export function DeviceInfoDTOFromJSONTyped(json: any, ignoreDiscriminator: boolean): DeviceInfoDTO {
    if (json == null) {
        return json;
    }
    return {
...
export function DeviceInfoDTOToJSON(json: any): DeviceInfoDTO {
    return DeviceInfoDTOToJSONTyped(json, false);
}

export function DeviceInfoDTOToJSONTyped(value?: DeviceInfoDTO | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
