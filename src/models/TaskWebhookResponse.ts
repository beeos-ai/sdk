...
import type { TaskWebhookResponseAllOfData } from './TaskWebhookResponseAllOfData';
import {
    TaskWebhookResponseAllOfDataFromJSON,
    TaskWebhookResponseAllOfDataFromJSONTyped,
    TaskWebhookResponseAllOfDataToJSON,
    TaskWebhookResponseAllOfDataToJSONTyped,
} from './TaskWebhookResponseAllOfData';

/**
 * 
 * @export
 * @interface TaskWebhookResponse
 */
export interface TaskWebhookResponse {
    /**
     * 
     * @type {boolean}
     * @memberof TaskWebhookResponse
     */
    success: TaskWebhookResponseSuccessEnum;
    /**
     * 
     * @type {TaskWebhookResponseAllOfData}
     * @memberof TaskWebhookResponse
     */
 ...
 * @export
 */
export const TaskWebhookResponseSuccessEnum = {
    True: true
} as const;
export type TaskWebhookResponseSuccessEnum = typeof TaskWebhookResponseSuccessEnum[keyof typeof TaskWebhookResponseSuccessEnum];


/**
 * Check if a given object implements the TaskWebhookResponse interface.
 */
export function instanceOfTaskWebhookResponse(value: object): value is TaskWebhookResponse {
    if (!('success' in value) || value['success'] === undefined) return false;
    if (!('data' in value) || value['data'] === undefined) return false;
    return true;
}

export function TaskWebhookResponseFromJSON(json: any): TaskWebhookResponse {
    return TaskWebhookResponseFromJSONTyped(json, false);
}

export function TaskWebhookResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): TaskWebhookResponse {
    if (json == null) {
        return json;
    }
    return {
        ...
        'data': TaskWebhookResponseAllOfDataFromJSON(json['data']),
    };
}

export function TaskWebhookResponseToJSON(json: any): TaskWebhookResponse {
    return TaskWebhookResponseToJSONTyped(json, false);
}

export function TaskWebhookResponseToJSONTyped(value?: TaskWebhookResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': TaskWebhookResponseAllOfDataToJSON(value['data']),
    };
}
