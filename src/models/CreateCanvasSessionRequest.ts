 ...
 */
export interface CreateCanvasSessionRequest {
    [key: string]: any | any;
    /**
     * 
     * @type {string}
     * @memberof CreateCanvasSessionRequest
     */
...
/**
 * Check if a given object implements the CreateCanvasSessionRequest interface.
 */
export function instanceOfCreateCanvasSessionRequest(value: object): value is CreateCanvasSessionRequest {
...
export function CreateCanvasSessionRequestFromJSON(json: any): CreateCanvasSessionRequest {
    return CreateCanvasSessionRequestFromJSONTyped(json, false);
}

export function CreateCanvasSessionRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateCanvasSessionRequest {
    if (json == null) {
        return json;
    }
    return {
        ...
        'canvasId': json['canvasId'] == null ? undefined : json['canvasId'],
    };
}

export function CreateCanvasSessionRequestToJSON(json: any): CreateCanvasSessionRequest {
    return CreateCanvasSessionRequestToJSONTyped(json, false);
}

export function CreateCanvasSessionRequestToJSONTyped(value?: CreateCanvasSessionRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
