 ...
 * 
 * @export
 * @interface InvokeRuntimeMethodRequest
 */
export interface InvokeRuntimeMethodRequest {
    [key: string]: any | any;
    /**
     * 
     * @type {string}
     * @memberof InvokeRuntimeMethodRequest
     */
    jsonrpc: InvokeRuntimeMethodRequestJsonrpcEnum;
    /**
     * 
     * @type {any}
     * @memberof InvokeRuntimeMethodRequest
 ...
 * @export
 */
export const InvokeRuntimeMethodRequestJsonrpcEnum = {
    _20: '2.0'
} as const;
export type InvokeRuntimeMethodRequestJsonrpcEnum = typeof InvokeRuntimeMethodRequestJsonrpcEnum[keyof typeof InvokeRuntimeMethodRequestJsonrpcEnum];


/**
 * Check if a given object implements the InvokeRuntimeMethodRequest interface.
 */
export function instanceOfInvokeRuntimeMethodRequest(value: object): value is InvokeRuntimeMethodRequest {
...
export function InvokeRuntimeMethodRequestFromJSON(json: any): InvokeRuntimeMethodRequest {
    return InvokeRuntimeMethodRequestFromJSONTyped(json, false);
}

export function InvokeRuntimeMethodRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): InvokeRuntimeMethodRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function InvokeRuntimeMethodRequestToJSON(json: any): InvokeRuntimeMethodRequest {
    return InvokeRuntimeMethodRequestToJSONTyped(json, false);
}

export function InvokeRuntimeMethodRequestToJSONTyped(value?: InvokeRuntimeMethodRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
