 ...
 * 
 * @export
 * @interface PartCustom
 */
export interface PartCustom {
    /**
     * 
     * @type {string}
     * @memberof PartCustom
     */
    type: PartCustomTypeEnum;
    /**
 ...
 * @export
 */
export const PartCustomTypeEnum = {
    Custom: 'custom'
} as const;
export type PartCustomTypeEnum = typeof PartCustomTypeEnum[keyof typeof PartCustomTypeEnum];


/**
 * Check if a given object implements the PartCustom interface.
 */
export function instanceOfPartCustom(value: object): value is PartCustom {
...
export function PartCustomFromJSON(json: any): PartCustom {
    return PartCustomFromJSONTyped(json, false);
}

export function PartCustomFromJSONTyped(json: any, ignoreDiscriminator: boolean): PartCustom {
    if (json == null) {
        return json;
    }
    return {
...
export function PartCustomToJSON(json: any): PartCustom {
    return PartCustomToJSONTyped(json, false);
}

export function PartCustomToJSONTyped(value?: PartCustom | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
