...
export function instanceOfStopReason(value: any): boolean {
    for (const key in StopReason) {
        if (Object.prototype.hasOwnProperty.call(StopReason, key)) {
            if (StopReason[key as keyof typeof StopReason] === value) {
                return true;
            }
        }
    }
...
export function StopReasonFromJSON(json: any): StopReason {
    return StopReasonFromJSONTyped(json, false);
}

export function StopReasonFromJSONTyped(json: any, ignoreDiscriminator: boolean): StopReason {
    return json as StopReason;
}

export function StopReasonToJSON(value?: StopReason | null): any {
    return value as any;
}

export function StopReasonToJSONTyped(value: any, ignoreDiscriminator: boolean): StopReason {
