 ...
 * 
 * @export
 * @interface ListTasksResponseAllOfData
 */
export interface ListTasksResponseAllOfData {
    /**
     * 
     * @type {Array<TaskSummary>}
     * @memberof ListTasksResponseAllOfData
     */
...
/**
 * Check if a given object implements the ListTasksResponseAllOfData interface.
 */
export function instanceOfListTasksResponseAllOfData(value: object): value is ListTasksResponseAllOfData {
    if (!('tasks' in value) || value['tasks'] === undefined) return false;
    return true;
}

export function ListTasksResponseAllOfDataFromJSON(json: any): ListTasksResponseAllOfData {
    return ListTasksResponseAllOfDataFromJSONTyped(json, false);
}

export function ListTasksResponseAllOfDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListTasksResponseAllOfData {
    if (json == null) {
        return json;
    }
    return {
...
export function ListTasksResponseAllOfDataToJSON(json: any): ListTasksResponseAllOfData {
    return ListTasksResponseAllOfDataToJSONTyped(json, false);
}

export function ListTasksResponseAllOfDataToJSONTyped(value?: ListTasksResponseAllOfData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
