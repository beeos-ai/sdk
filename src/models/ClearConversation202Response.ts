 ...
 * 
 * @export
 * @interface ClearConversation202Response
 */
export interface ClearConversation202Response {
    [key: string]: any | any;
    /**
     * 
     * @type {string}
     * @memberof ClearConversation202Response
     */
    status: ClearConversation202ResponseStatusEnum;
    /**
     * 
     * @type {string}
     * @memberof ClearConversation202Response
 ...
 * @export
 */
export const ClearConversation202ResponseStatusEnum = {
    Accepted: 'accepted'
} as const;
export type ClearConversation202ResponseStatusEnum = typeof ClearConversation202ResponseStatusEnum[keyof typeof ClearConversation202ResponseStatusEnum];


/**
 * Check if a given object implements the ClearConversation202Response interface.
 */
export function instanceOfClearConversation202Response(value: object): value is ClearConversation202Response {
    ...
    if (!('currentGeneration' in value) || value['currentGeneration'] === undefined) return false;
    return true;
}

export function ClearConversation202ResponseFromJSON(json: any): ClearConversation202Response {
    return ClearConversation202ResponseFromJSONTyped(json, false);
}

export function ClearConversation202ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ClearConversation202Response {
    if (json == null) {
        return json;
    }
    return {
        ...
        'currentGeneration': json['currentGeneration'],
    };
}

export function ClearConversation202ResponseToJSON(json: any): ClearConversation202Response {
    return ClearConversation202ResponseToJSONTyped(json, false);
}

export function ClearConversation202ResponseToJSONTyped(value?: ClearConversation202Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
