...
/**
 * Check if a given object implements the DragRequest interface.
 */
export function instanceOfDragRequest(value: object): value is DragRequest {
...
export function DragRequestFromJSON(json: any): DragRequest {
    return DragRequestFromJSONTyped(json, false);
}

export function DragRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): DragRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function DragRequestToJSON(json: any): DragRequest {
    return DragRequestToJSONTyped(json, false);
}

export function DragRequestToJSONTyped(value?: DragRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
