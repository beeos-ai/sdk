...
export interface CreateTerminalSessionRequest {
     ...
     * 
     * @type {string}
     * @memberof CreateTerminalSessionRequest
     */
...
/**
 * Check if a given object implements the CreateTerminalSessionRequest interface.
 */
export function instanceOfCreateTerminalSessionRequest(value: object): value is CreateTerminalSessionRequest {
    if (!('platformAgentId' in value) || value['platformAgentId'] === undefined) return false;
    return true;
}

export function CreateTerminalSessionRequestFromJSON(json: any): CreateTerminalSessionRequest {
    return CreateTerminalSessionRequestFromJSONTyped(json, false);
}

export function CreateTerminalSessionRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateTerminalSessionRequest {
    if (json == null) {
        return json;
    }
    return {
        ...
        'resumeTerminalId': json['resumeTerminalId'] == null ? undefined : json['resumeTerminalId'],
    };
}

export function CreateTerminalSessionRequestToJSON(json: any): CreateTerminalSessionRequest {
    return CreateTerminalSessionRequestToJSONTyped(json, false);
}

export function CreateTerminalSessionRequestToJSONTyped(value?: CreateTerminalSessionRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'resumeTerminalId': value['resumeTerminalId'],
    };
}
