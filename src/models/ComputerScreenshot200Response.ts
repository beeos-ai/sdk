...
import {
    ScreenshotResultFromJSON,
    ScreenshotResultFromJSONTyped,
    ScreenshotResultToJSON,
    ScreenshotResultToJSONTyped,
} from './ScreenshotResult';

/**
 * 
 * @export
 * @interface ComputerScreenshot200Response
 */
export interface ComputerScreenshot200Response {
    /**
     * 
     * @type {boolean}
     * @memberof ComputerScreenshot200Response
     */
    success: ComputerScreenshot200ResponseSuccessEnum;
    /**
     * 
 ...
 * @export
 */
export const ComputerScreenshot200ResponseSuccessEnum = {
    True: true
} as const;
export type ComputerScreenshot200ResponseSuccessEnum = typeof ComputerScreenshot200ResponseSuccessEnum[keyof typeof ComputerScreenshot200ResponseSuccessEnum];


/**
 * Check if a given object implements the ComputerScreenshot200Response interface.
 */
export function instanceOfComputerScreenshot200Response(value: object): value is ComputerScreenshot200Response {
    if (!('success' in value) || value['success'] === undefined) return false;
    return true;
}

export function ComputerScreenshot200ResponseFromJSON(json: any): ComputerScreenshot200Response {
    return ComputerScreenshot200ResponseFromJSONTyped(json, false);
}

export function ComputerScreenshot200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ComputerScreenshot200Response {
    if (json == null) {
        return json;
    }
    return {
        ...
        'data': json['data'] == null ? undefined : ScreenshotResultFromJSON(json['data']),
    };
}

export function ComputerScreenshot200ResponseToJSON(json: any): ComputerScreenshot200Response {
    return ComputerScreenshot200ResponseToJSONTyped(json, false);
}

export function ComputerScreenshot200ResponseToJSONTyped(value?: ComputerScreenshot200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': ScreenshotResultToJSON(value['data']),
    };
}
