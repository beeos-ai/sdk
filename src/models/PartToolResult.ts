...
import type { PartToolResultContent } from './PartToolResultContent';
import {
    PartToolResultContentFromJSON,
    PartToolResultContentFromJSONTyped,
    PartToolResultContentToJSON,
    PartToolResultContentToJSONTyped,
} from './PartToolResultContent';

/**
 * Tool-call output, paired with the originating tool_use via `tool_use_id`.
 * @export
 * @interface PartToolResult
 */
export interface PartToolResult {
    /**
     * 
     * @type {string}
     * @memberof PartToolResult
     */
    type: PartToolResultTypeEnum;
    /**
     * 
     * @type {string}
     * @memberof PartToolResult
 ...
 * @export
 */
export const PartToolResultTypeEnum = {
    ToolResult: 'tool_result'
} as const;
export type PartToolResultTypeEnum = typeof PartToolResultTypeEnum[keyof typeof PartToolResultTypeEnum];


/**
 * Check if a given object implements the PartToolResult interface.
 */
export function instanceOfPartToolResult(value: object): value is PartToolResult {
...
export function PartToolResultFromJSON(json: any): PartToolResult {
    return PartToolResultFromJSONTyped(json, false);
}

export function PartToolResultFromJSONTyped(json: any, ignoreDiscriminator: boolean): PartToolResult {
    if (json == null) {
        return json;
    }
    return {
        ...
        'content': PartToolResultContentFromJSON(json['content']),
        'isError': json['is_error'] == null ? undefined : json['is_error'],
    };
}

export function PartToolResultToJSON(json: any): PartToolResult {
    return PartToolResultToJSONTyped(json, false);
}

export function PartToolResultToJSONTyped(value?: PartToolResult | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'content': PartToolResultContentToJSON(value['content']),
