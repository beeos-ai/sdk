...
/**
 * A captured screenshot staged in BeeOS file storage. The image is
 * referenced by `file_id` + a short-lived presigned `url`, never
 * inline base64.
 * 
 * @export
...
/**
 * Check if a given object implements the ScreenshotResult interface.
 */
export function instanceOfScreenshotResult(value: object): value is ScreenshotResult {
    if (!('fileId' in value) || value['fileId'] === undefined) return false;
    if (!('url' in value) || value['url'] === undefined) return false;
    return true;
}

export function ScreenshotResultFromJSON(json: any): ScreenshotResult {
    return ScreenshotResultFromJSONTyped(json, false);
}

export function ScreenshotResultFromJSONTyped(json: any, ignoreDiscriminator: boolean): ScreenshotResult {
    if (json == null) {
        return json;
    }
    return {
...
export function ScreenshotResultToJSON(json: any): ScreenshotResult {
    return ScreenshotResultToJSONTyped(json, false);
}

export function ScreenshotResultToJSONTyped(value?: ScreenshotResult | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
