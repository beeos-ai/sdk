...
import type { RuntimeOperationSnapshot } from './RuntimeOperationSnapshot';
import {
    RuntimeOperationSnapshotFromJSON,
    RuntimeOperationSnapshotFromJSONTyped,
    RuntimeOperationSnapshotToJSON,
    RuntimeOperationSnapshotToJSONTyped,
} from './RuntimeOperationSnapshot';

/**
 * 
 * @export
 * @interface ServiceOperationsListResponse
 */
export interface ServiceOperationsListResponse {
    [key: string]: any | any;
    /**
     * 
     * @type {Array<RuntimeOperationSnapshot>}
     * @memberof ServiceOperationsListResponse
     */
    operations: Array<RuntimeOperationSnapshot>;
    /**
     * 
     * @type {string}
     * @memberof ServiceOperationsListResponse
...
/**
 * Check if a given object implements the ServiceOperationsListResponse interface.
 */
export function instanceOfServiceOperationsListResponse(value: object): value is ServiceOperationsListResponse {
    if (!('operations' in value) || value['operations'] === undefined) return false;
    return true;
}

export function ServiceOperationsListResponseFromJSON(json: any): ServiceOperationsListResponse {
    return ServiceOperationsListResponseFromJSONTyped(json, false);
}

export function ServiceOperationsListResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ServiceOperationsListResponse {
    if (json == null) {
        return json;
    }
    return {
            ...
            ...json,
        'operations': ((json['operations'] as Array<any>).map(RuntimeOperationSnapshotFromJSON)),
        'nextCursor': json['nextCursor'] == null ? undefined : json['nextCursor'],
    };
}

export function ServiceOperationsListResponseToJSON(json: any): ServiceOperationsListResponse {
    return ServiceOperationsListResponseToJSONTyped(json, false);
}

export function ServiceOperationsListResponseToJSONTyped(value?: ServiceOperationsListResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
            ...
            ...value,
        'operations': ((value['operations'] as Array<any>).map(RuntimeOperationSnapshotToJSON)),
