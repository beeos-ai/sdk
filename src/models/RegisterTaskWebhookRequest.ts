 ...
 * 
 * @export
 * @interface RegisterTaskWebhookRequest
 */
export interface RegisterTaskWebhookRequest {
    /**
     * Absolute HTTPS endpoint to POST callbacks to. The receiver
     * gets the protocol-specific payload (OpenAPI: a task event
     * envelope; A2A: JSON-RPC StreamResponse; MCP: notification).
     * 
     * @type {string}
     * @memberof RegisterTaskWebhookRequest
     */
    url: string;
    /**
...
/**
 * Check if a given object implements the RegisterTaskWebhookRequest interface.
 */
export function instanceOfRegisterTaskWebhookRequest(value: object): value is RegisterTaskWebhookRequest {
    if (!('url' in value) || value['url'] === undefined) return false;
    return true;
}

export function RegisterTaskWebhookRequestFromJSON(json: any): RegisterTaskWebhookRequest {
    return RegisterTaskWebhookRequestFromJSONTyped(json, false);
}

export function RegisterTaskWebhookRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): RegisterTaskWebhookRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function RegisterTaskWebhookRequestToJSON(json: any): RegisterTaskWebhookRequest {
    return RegisterTaskWebhookRequestToJSONTyped(json, false);
}

export function RegisterTaskWebhookRequestToJSONTyped(value?: RegisterTaskWebhookRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
