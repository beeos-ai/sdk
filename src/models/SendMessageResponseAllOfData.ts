 ...
 * 
 * @export
 * @interface SendMessageResponseAllOfData
 */
export interface SendMessageResponseAllOfData {
    /**
     * 
     * @type {string}
     * @memberof SendMessageResponseAllOfData
     */
    messageId: string;
    /**
     * 
...
/**
 * Check if a given object implements the SendMessageResponseAllOfData interface.
 */
export function instanceOfSendMessageResponseAllOfData(value: object): value is SendMessageResponseAllOfData {
    if (!('messageId' in value) || value['messageId'] === undefined) return false;
    return true;
}

export function SendMessageResponseAllOfDataFromJSON(json: any): SendMessageResponseAllOfData {
    return SendMessageResponseAllOfDataFromJSONTyped(json, false);
}

export function SendMessageResponseAllOfDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): SendMessageResponseAllOfData {
    if (json == null) {
        return json;
    }
    return {
...
export function SendMessageResponseAllOfDataToJSON(json: any): SendMessageResponseAllOfData {
    return SendMessageResponseAllOfDataToJSONTyped(json, false);
}

export function SendMessageResponseAllOfDataToJSONTyped(value?: SendMessageResponseAllOfData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
