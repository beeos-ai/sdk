...
import type { TaskResponseAllOfData } from './TaskResponseAllOfData';
import {
    TaskResponseAllOfDataFromJSON,
    TaskResponseAllOfDataFromJSONTyped,
    TaskResponseAllOfDataToJSON,
    TaskResponseAllOfDataToJSONTyped,
} from './TaskResponseAllOfData';
...
export interface TaskResponse {
     ...
     */
    success: TaskResponseSuccessEnum;
    /**
     * 
     * @type {TaskResponseAllOfData}
     * @memberof TaskResponse
     */
 ...
 * @export
 */
export const TaskResponseSuccessEnum = {
    True: true
} as const;
export type TaskResponseSuccessEnum = typeof TaskResponseSuccessEnum[keyof typeof TaskResponseSuccessEnum];
...
export function TaskResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): TaskResponse {
    ...
    return {
        ...
        'data': TaskResponseAllOfDataFromJSON(json['data']),
    };
}
...
export function TaskResponseToJSONTyped(value?: TaskResponse | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'data': TaskResponseAllOfDataToJSON(value['data']),
    };
}
