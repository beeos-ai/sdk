 ...
 * 
 * @export
 * @interface ServiceOperationCancelAccepted
 */
export interface ServiceOperationCancelAccepted {
    [key: string]: any | any;
    /**
     * 
     * @type {string}
     * @memberof ServiceOperationCancelAccepted
     */
    status: ServiceOperationCancelAcceptedStatusEnum;
    /**
     * 
     * @type {string}
     * @memberof ServiceOperationCancelAccepted
 ...
 * @export
 */
export const ServiceOperationCancelAcceptedStatusEnum = {
    CancelRequested: 'cancel_requested'
} as const;
export type ServiceOperationCancelAcceptedStatusEnum = typeof ServiceOperationCancelAcceptedStatusEnum[keyof typeof ServiceOperationCancelAcceptedStatusEnum];


/**
 * Check if a given object implements the ServiceOperationCancelAccepted interface.
 */
export function instanceOfServiceOperationCancelAccepted(value: object): value is ServiceOperationCancelAccepted {
    if (!('status' in value) || value['status'] === undefined) return false;
    if (!('operationId' in value) || value['operationId'] === undefined) return false;
    return true;
}

export function ServiceOperationCancelAcceptedFromJSON(json: any): ServiceOperationCancelAccepted {
    return ServiceOperationCancelAcceptedFromJSONTyped(json, false);
}

export function ServiceOperationCancelAcceptedFromJSONTyped(json: any, ignoreDiscriminator: boolean): ServiceOperationCancelAccepted {
    if (json == null) {
        return json;
    }
    return {
...
export function ServiceOperationCancelAcceptedToJSON(json: any): ServiceOperationCancelAccepted {
    return ServiceOperationCancelAcceptedToJSONTyped(json, false);
}

export function ServiceOperationCancelAcceptedToJSONTyped(value?: ServiceOperationCancelAccepted | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
