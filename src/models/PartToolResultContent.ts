 ...
 * @export
 */
export type PartToolResultContent = string | { [key: string]: any; };

export function PartToolResultContentFromJSON(json: any): PartToolResultContent {
    return PartToolResultContentFromJSONTyped(json, false);
}

export function PartToolResultContentFromJSONTyped(json: any, ignoreDiscriminator: boolean): PartToolResultContent {
    if (json == null) {
        return json;
    }
...
export function PartToolResultContentToJSON(json: any): any {
    return PartToolResultContentToJSONTyped(json, false);
}

export function PartToolResultContentToJSONTyped(value?: PartToolResultContent | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
