...
export type PartState = typeof PartState[keyof typeof PartState];


export function instanceOfPartState(value: any): boolean {
    for (const key in PartState) {
        if (Object.prototype.hasOwnProperty.call(PartState, key)) {
            if (PartState[key as keyof typeof PartState] === value) {
                return true;
            }
        }
    }
...
export function PartStateFromJSON(json: any): PartState {
    return PartStateFromJSONTyped(json, false);
}

export function PartStateFromJSONTyped(json: any, ignoreDiscriminator: boolean): PartState {
    return json as PartState;
}

export function PartStateToJSON(value?: PartState | null): any {
    return value as any;
}

export function PartStateToJSONTyped(value: any, ignoreDiscriminator: boolean): PartState {
