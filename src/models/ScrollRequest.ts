...
/**
 * Check if a given object implements the ScrollRequest interface.
 */
export function instanceOfScrollRequest(value: object): value is ScrollRequest {
    if (!('direction' in value) || value['direction'] === undefined) return false;
    return true;
}

export function ScrollRequestFromJSON(json: any): ScrollRequest {
    return ScrollRequestFromJSONTyped(json, false);
}

export function ScrollRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ScrollRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function ScrollRequestToJSON(json: any): ScrollRequest {
    return ScrollRequestToJSONTyped(json, false);
}

export function ScrollRequestToJSONTyped(value?: ScrollRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
