...
import type { ListWebhookDeliveriesResponseAllOfData } from './ListWebhookDeliveriesResponseAllOfData';
import {
    ListWebhookDeliveriesResponseAllOfDataFromJSON,
    ListWebhookDeliveriesResponseAllOfDataFromJSONTyped,
    ListWebhookDeliveriesResponseAllOfDataToJSON,
    ListWebhookDeliveriesResponseAllOfDataToJSONTyped,
} from './ListWebhookDeliveriesResponseAllOfData';
...
export interface ListWebhookDeliveriesResponse {
     ...
     * 
     * @type {boolean}
     * @memberof ListWebhookDeliveriesResponse
     */
    success: ListWebhookDeliveriesResponseSuccessEnum;
    /**
     * 
     * @type {ListWebhookDeliveriesResponseAllOfData}
     * @memberof ListWebhookDeliveriesResponse
     */
 ...
 * @export
 */
export const ListWebhookDeliveriesResponseSuccessEnum = {
    True: true
} as const;
export type ListWebhookDeliveriesResponseSuccessEnum = typeof ListWebhookDeliveriesResponseSuccessEnum[keyof typeof ListWebhookDeliveriesResponseSuccessEnum];


/**
 * Check if a given object implements the ListWebhookDeliveriesResponse interface.
 */
export function instanceOfListWebhookDeliveriesResponse(value: object): value is ListWebhookDeliveriesResponse {
    if (!('success' in value) || value['success'] === undefined) return false;
    if (!('data' in value) || value['data'] === undefined) return false;
    return true;
}

export function ListWebhookDeliveriesResponseFromJSON(json: any): ListWebhookDeliveriesResponse {
    return ListWebhookDeliveriesResponseFromJSONTyped(json, false);
}

export function ListWebhookDeliveriesResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListWebhookDeliveriesResponse {
    if (json == null) {
        return json;
    }
    return {
        ...
        'data': ListWebhookDeliveriesResponseAllOfDataFromJSON(json['data']),
    };
}

export function ListWebhookDeliveriesResponseToJSON(json: any): ListWebhookDeliveriesResponse {
    return ListWebhookDeliveriesResponseToJSONTyped(json, false);
}

export function ListWebhookDeliveriesResponseToJSONTyped(value?: ListWebhookDeliveriesResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': ListWebhookDeliveriesResponseAllOfDataToJSON(value['data']),
    };
}
