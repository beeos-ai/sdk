...
/**
 * Agent reasoning ("thinking") chunk, delivered on a parallel
 * stream independent of the answer `delta` frames. Concatenate
 * `reasoning` text in order for the full chain-of-thought; it does
 * NOT contribute to the final answer text. Optional to render.
 * 
 * @export
 * @interface InvokeAgentSSEReasoning
 */
export interface InvokeAgentSSEReasoning {
    /**
     * 
     * @type {string}
     * @memberof InvokeAgentSSEReasoning
     */
    type: InvokeAgentSSEReasoningTypeEnum;
    /**
 ...
 * @export
 */
export const InvokeAgentSSEReasoningTypeEnum = {
    Reasoning: 'reasoning'
} as const;
export type InvokeAgentSSEReasoningTypeEnum = typeof InvokeAgentSSEReasoningTypeEnum[keyof typeof InvokeAgentSSEReasoningTypeEnum];


/**
 * Check if a given object implements the InvokeAgentSSEReasoning interface.
 */
export function instanceOfInvokeAgentSSEReasoning(value: object): value is InvokeAgentSSEReasoning {
    if (!('type' in value) || value['type'] === undefined) return false;
    if (!('text' in value) || value['text'] === undefined) return false;
    return true;
}

export function InvokeAgentSSEReasoningFromJSON(json: any): InvokeAgentSSEReasoning {
    return InvokeAgentSSEReasoningFromJSONTyped(json, false);
}

export function InvokeAgentSSEReasoningFromJSONTyped(json: any, ignoreDiscriminator: boolean): InvokeAgentSSEReasoning {
    if (json == null) {
        return json;
    }
    return {
...
export function InvokeAgentSSEReasoningToJSON(json: any): InvokeAgentSSEReasoning {
    return InvokeAgentSSEReasoningToJSONTyped(json, false);
}

export function InvokeAgentSSEReasoningToJSONTyped(value?: InvokeAgentSSEReasoning | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
