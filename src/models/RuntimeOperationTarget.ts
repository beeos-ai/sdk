...
import type { RuntimeOperationTargetOneOf } from './RuntimeOperationTargetOneOf';
import type { RuntimeOperationTargetOneOf1 } from './RuntimeOperationTargetOneOf1';
import type { RuntimeOperationTargetOneOf2 } from './RuntimeOperationTargetOneOf2';
 ...
 * @export
 */
export type RuntimeOperationTarget = RuntimeOperationTargetOneOf | RuntimeOperationTargetOneOf1 | RuntimeOperationTargetOneOf2;

export function RuntimeOperationTargetFromJSON(json: any): RuntimeOperationTarget {
    return RuntimeOperationTargetFromJSONTyped(json, false);
}

export function RuntimeOperationTargetFromJSONTyped(json: any, ignoreDiscriminator: boolean): RuntimeOperationTarget {
    if (json == null) {
        return json;
    }

    return json as RuntimeOperationTarget;
}

export function RuntimeOperationTargetToJSON(json: any): any {
    return RuntimeOperationTargetToJSONTyped(json, false);
}

export function RuntimeOperationTargetToJSONTyped(value?: RuntimeOperationTarget | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
