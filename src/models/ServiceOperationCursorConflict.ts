 ...
 * 
 * @export
 * @interface ServiceOperationCursorConflict
 */
export interface ServiceOperationCursorConflict {
    [key: string]: any | any;
    /**
     * 
     * @type {any}
     * @memberof ServiceOperationCursorConflict
     */
    code: any | null;
    /**
     * 
...
/**
 * Check if a given object implements the ServiceOperationCursorConflict interface.
 */
export function instanceOfServiceOperationCursorConflict(value: object): value is ServiceOperationCursorConflict {
    ...
    if (!('lastSequence' in value) || value['lastSequence'] === undefined) return false;
    if (!('httpStatus' in value) || value['httpStatus'] === undefined) return false;
    return true;
}

export function ServiceOperationCursorConflictFromJSON(json: any): ServiceOperationCursorConflict {
    return ServiceOperationCursorConflictFromJSONTyped(json, false);
}

export function ServiceOperationCursorConflictFromJSONTyped(json: any, ignoreDiscriminator: boolean): ServiceOperationCursorConflict {
    if (json == null) {
        return json;
    }
    return {
...
export function ServiceOperationCursorConflictToJSON(json: any): ServiceOperationCursorConflict {
    return ServiceOperationCursorConflictToJSONTyped(json, false);
}

export function ServiceOperationCursorConflictToJSONTyped(value?: ServiceOperationCursorConflict | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
