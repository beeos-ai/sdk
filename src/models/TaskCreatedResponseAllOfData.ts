 ...
 * 
 * @export
 * @interface TaskCreatedResponseAllOfData
 */
export interface TaskCreatedResponseAllOfData {
    /**
     * Stable task identifier (== underlying channel_id).
     * @type {string}
     * @memberof TaskCreatedResponseAllOfData
     */
    taskId: string;
    /**
     * 
...
/**
 * Check if a given object implements the TaskCreatedResponseAllOfData interface.
 */
export function instanceOfTaskCreatedResponseAllOfData(value: object): value is TaskCreatedResponseAllOfData {
...
export function TaskCreatedResponseAllOfDataFromJSON(json: any): TaskCreatedResponseAllOfData {
    return TaskCreatedResponseAllOfDataFromJSONTyped(json, false);
}

export function TaskCreatedResponseAllOfDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): TaskCreatedResponseAllOfData {
    if (json == null) {
        return json;
    }
    return {
...
export function TaskCreatedResponseAllOfDataToJSON(json: any): TaskCreatedResponseAllOfData {
    return TaskCreatedResponseAllOfDataToJSONTyped(json, false);
}

export function TaskCreatedResponseAllOfDataToJSONTyped(value?: TaskCreatedResponseAllOfData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
