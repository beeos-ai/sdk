 ...
 * @export
 * @interface PartToolUse
 */
export interface PartToolUse {
    /**
     * 
     * @type {string}
     * @memberof PartToolUse
     */
    type: PartToolUseTypeEnum;
    /**
 ...
 * @export
 */
export const PartToolUseTypeEnum = {
    ToolUse: 'tool_use'
} as const;
export type PartToolUseTypeEnum = typeof PartToolUseTypeEnum[keyof typeof PartToolUseTypeEnum];


/**
 * Check if a given object implements the PartToolUse interface.
 */
export function instanceOfPartToolUse(value: object): value is PartToolUse {
...
export function PartToolUseFromJSON(json: any): PartToolUse {
    return PartToolUseFromJSONTyped(json, false);
}

export function PartToolUseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PartToolUse {
    if (json == null) {
        return json;
    }
    return {
...
export function PartToolUseToJSON(json: any): PartToolUse {
    return PartToolUseToJSONTyped(json, false);
}

export function PartToolUseToJSONTyped(value?: PartToolUse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
