...
import type { UITreeResult } from './UITreeResult';
import {
    UITreeResultFromJSON,
    UITreeResultFromJSONTyped,
    UITreeResultToJSON,
    UITreeResultToJSONTyped,
} from './UITreeResult';

/**
 *
 * @export
 * @interface MobileGetUiTree200Response
 */
export interface MobileGetUiTree200Response {
    /**
     *
     * @type {boolean}
     * @memberof MobileGetUiTree200Response
     */
    success: MobileGetUiTree200ResponseSuccessEnum;
    /**
     *
     * @type {UITreeResult}
     * @memberof MobileGetUiTree200Response
 ...
 * @export
 */
export const MobileGetUiTree200ResponseSuccessEnum = {
    True: true
} as const;
export type MobileGetUiTree200ResponseSuccessEnum = typeof MobileGetUiTree200ResponseSuccessEnum[keyof typeof MobileGetUiTree200ResponseSuccessEnum];


/**
 * Check if a given object implements the MobileGetUiTree200Response interface.
 */
export function instanceOfMobileGetUiTree200Response(value: object): value is MobileGetUiTree200Response {
    if (!('success' in value) || value['success'] === undefined) return false;
    return true;
}

export function MobileGetUiTree200ResponseFromJSON(json: any): MobileGetUiTree200Response {
    return MobileGetUiTree200ResponseFromJSONTyped(json, false);
}

export function MobileGetUiTree200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): MobileGetUiTree200Response {
    if (json == null) {
        return json;
    }
    return {
        ...
        'data': json['data'] == null ? undefined : UITreeResultFromJSON(json['data']),
    };
}

export function MobileGetUiTree200ResponseToJSON(json: any): MobileGetUiTree200Response {
    return MobileGetUiTree200ResponseToJSONTyped(json, false);
}

export function MobileGetUiTree200ResponseToJSONTyped(value?: MobileGetUiTree200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': UITreeResultToJSON(value['data']),
    };
}
