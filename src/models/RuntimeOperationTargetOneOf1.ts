 ...
 * 
 * @export
 * @interface RuntimeOperationTargetOneOf1
 */
export interface RuntimeOperationTargetOneOf1 {
    [key: string]: any | any;
    /**
     * 
     * @type {string}
     * @memberof RuntimeOperationTargetOneOf1
     */
    scope: RuntimeOperationTargetOneOf1ScopeEnum;
    /**
     * 
     * @type {string}
     * @memberof RuntimeOperationTargetOneOf1
 ...
 * @export
 */
export const RuntimeOperationTargetOneOf1ScopeEnum = {
    Agent: 'agent'
} as const;
export type RuntimeOperationTargetOneOf1ScopeEnum = typeof RuntimeOperationTargetOneOf1ScopeEnum[keyof typeof RuntimeOperationTargetOneOf1ScopeEnum];


/**
 * Check if a given object implements the RuntimeOperationTargetOneOf1 interface.
 */
export function instanceOfRuntimeOperationTargetOneOf1(value: object): value is RuntimeOperationTargetOneOf1 {
    if (!('scope' in value) || value['scope'] === undefined) return false;
    if (!('platformAgentId' in value) || value['platformAgentId'] === undefined) return false;
    return true;
}

export function RuntimeOperationTargetOneOf1FromJSON(json: any): RuntimeOperationTargetOneOf1 {
    return RuntimeOperationTargetOneOf1FromJSONTyped(json, false);
}

export function RuntimeOperationTargetOneOf1FromJSONTyped(json: any, ignoreDiscriminator: boolean): RuntimeOperationTargetOneOf1 {
    if (json == null) {
        return json;
    }
    return {
            ...
            ...json,
        'scope': json['scope'],
        'platformAgentId': json['platformAgentId'],
    };
}

export function RuntimeOperationTargetOneOf1ToJSON(json: any): RuntimeOperationTargetOneOf1 {
    return RuntimeOperationTargetOneOf1ToJSONTyped(json, false);
}

export function RuntimeOperationTargetOneOf1ToJSONTyped(value?: RuntimeOperationTargetOneOf1 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
