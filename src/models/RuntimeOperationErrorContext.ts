 ...
 * 
 * @export
 * @interface RuntimeOperationErrorContext
 */
export interface RuntimeOperationErrorContext {
    [key: string]: any | any;
    /**
     * 
     * @type {string}
     * @memberof RuntimeOperationErrorContext
     */
...
/**
 * Check if a given object implements the RuntimeOperationErrorContext interface.
 */
export function instanceOfRuntimeOperationErrorContext(value: object): value is RuntimeOperationErrorContext {
    return true;
}

export function RuntimeOperationErrorContextFromJSON(json: any): RuntimeOperationErrorContext {
    return RuntimeOperationErrorContextFromJSONTyped(json, false);
}

export function RuntimeOperationErrorContextFromJSONTyped(json: any, ignoreDiscriminator: boolean): RuntimeOperationErrorContext {
    if (json == null) {
        return json;
    }
    return {
            ...
            ...json,
        'activeRuntimeEpoch': json['activeRuntimeEpoch'] == null ? undefined : json['activeRuntimeEpoch'],
        ...
        'expectedContractRevision': json['expectedContractRevision'] == null ? undefined : json['expectedContractRevision'],
        'resourceId': json['resourceId'] == null ? undefined : json['resourceId'],
    };
}

export function RuntimeOperationErrorContextToJSON(json: any): RuntimeOperationErrorContext {
    return RuntimeOperationErrorContextToJSONTyped(json, false);
}

export function RuntimeOperationErrorContextToJSONTyped(value?: RuntimeOperationErrorContext | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
            ...
            ...value,
        'activeRuntimeEpoch': value['activeRuntimeEpoch'],
        'projectionRevision': value['projectionRevision'],
        'retryAfterMs': value['retryAfterMs'],
        'expectedContractRevision': value['expectedContractRevision'],
