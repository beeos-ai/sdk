 ...
 * 
 * @export
 * @interface ListMessagesResponseAllOfData
 */
export interface ListMessagesResponseAllOfData {
    /**
     * 
     * @type {Array<MessageDTO>}
     * @memberof ListMessagesResponseAllOfData
     */
...
/**
 * Check if a given object implements the ListMessagesResponseAllOfData interface.
 */
export function instanceOfListMessagesResponseAllOfData(value: object): value is ListMessagesResponseAllOfData {
    if (!('messages' in value) || value['messages'] === undefined) return false;
    if (!('latestOffset' in value) || value['latestOffset'] === undefined) return false;
    if (!('hasMore' in value) || value['hasMore'] === undefined) return false;
    return true;
}

export function ListMessagesResponseAllOfDataFromJSON(json: any): ListMessagesResponseAllOfData {
    return ListMessagesResponseAllOfDataFromJSONTyped(json, false);
}

export function ListMessagesResponseAllOfDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListMessagesResponseAllOfData {
    if (json == null) {
        return json;
    }
    return {
        ...
        'latestOffset': json['latest_offset'],
        'nextSince': json['next_since'] == null ? undefined : json['next_since'],
        'hasMore': json['has_more'],
    };
}

export function ListMessagesResponseAllOfDataToJSON(json: any): ListMessagesResponseAllOfData {
    return ListMessagesResponseAllOfDataToJSONTyped(json, false);
}

export function ListMessagesResponseAllOfDataToJSONTyped(value?: ListMessagesResponseAllOfData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'latest_offset': value['latestOffset'],
