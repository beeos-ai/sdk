...
/**
 * Check if a given object implements the AttachmentRef interface.
 */
export function instanceOfAttachmentRef(value: object): value is AttachmentRef {
    if (!('fileId' in value) || value['fileId'] === undefined) return false;
    return true;
}

export function AttachmentRefFromJSON(json: any): AttachmentRef {
    return AttachmentRefFromJSONTyped(json, false);
}

export function AttachmentRefFromJSONTyped(json: any, ignoreDiscriminator: boolean): AttachmentRef {
    if (json == null) {
        return json;
    }
    return {
...
export function AttachmentRefToJSON(json: any): AttachmentRef {
    return AttachmentRefToJSONTyped(json, false);
}

export function AttachmentRefToJSONTyped(value?: AttachmentRef | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
