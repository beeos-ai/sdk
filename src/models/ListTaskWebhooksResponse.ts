...
import type { ListTaskWebhooksResponseAllOfData } from './ListTaskWebhooksResponseAllOfData';
import {
    ListTaskWebhooksResponseAllOfDataFromJSON,
    ListTaskWebhooksResponseAllOfDataFromJSONTyped,
    ListTaskWebhooksResponseAllOfDataToJSON,
    ListTaskWebhooksResponseAllOfDataToJSONTyped,
} from './ListTaskWebhooksResponseAllOfData';

/**
 * 
 * @export
 * @interface ListTaskWebhooksResponse
 */
export interface ListTaskWebhooksResponse {
    /**
     * 
     * @type {boolean}
     * @memberof ListTaskWebhooksResponse
     */
    success: ListTaskWebhooksResponseSuccessEnum;
    /**
     * 
     * @type {ListTaskWebhooksResponseAllOfData}
     * @memberof ListTaskWebhooksResponse
     */
 ...
 * @export
 */
export const ListTaskWebhooksResponseSuccessEnum = {
    True: true
} as const;
export type ListTaskWebhooksResponseSuccessEnum = typeof ListTaskWebhooksResponseSuccessEnum[keyof typeof ListTaskWebhooksResponseSuccessEnum];


/**
 * Check if a given object implements the ListTaskWebhooksResponse interface.
 */
export function instanceOfListTaskWebhooksResponse(value: object): value is ListTaskWebhooksResponse {
    if (!('success' in value) || value['success'] === undefined) return false;
    if (!('data' in value) || value['data'] === undefined) return false;
    return true;
}

export function ListTaskWebhooksResponseFromJSON(json: any): ListTaskWebhooksResponse {
    return ListTaskWebhooksResponseFromJSONTyped(json, false);
}

export function ListTaskWebhooksResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListTaskWebhooksResponse {
    if (json == null) {
        return json;
    }
    return {
        ...
        'data': ListTaskWebhooksResponseAllOfDataFromJSON(json['data']),
    };
}

export function ListTaskWebhooksResponseToJSON(json: any): ListTaskWebhooksResponse {
    return ListTaskWebhooksResponseToJSONTyped(json, false);
}

export function ListTaskWebhooksResponseToJSONTyped(value?: ListTaskWebhooksResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': ListTaskWebhooksResponseAllOfDataToJSON(value['data']),
    };
}
