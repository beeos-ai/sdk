...
import type { PresignUploadResponse } from './PresignUploadResponse';
import {
    PresignUploadResponseFromJSON,
    PresignUploadResponseFromJSONTyped,
    PresignUploadResponseToJSON,
    PresignUploadResponseToJSONTyped,
} from './PresignUploadResponse';

/**
 * 
 * @export
 * @interface PresignFileUpload200Response
 */
export interface PresignFileUpload200Response {
    /**
     * 
     * @type {boolean}
     * @memberof PresignFileUpload200Response
     */
    success: PresignFileUpload200ResponseSuccessEnum;
    /**
     * 
 ...
 * @export
 */
export const PresignFileUpload200ResponseSuccessEnum = {
    True: true
} as const;
export type PresignFileUpload200ResponseSuccessEnum = typeof PresignFileUpload200ResponseSuccessEnum[keyof typeof PresignFileUpload200ResponseSuccessEnum];


/**
 * Check if a given object implements the PresignFileUpload200Response interface.
 */
export function instanceOfPresignFileUpload200Response(value: object): value is PresignFileUpload200Response {
    if (!('success' in value) || value['success'] === undefined) return false;
    return true;
}

export function PresignFileUpload200ResponseFromJSON(json: any): PresignFileUpload200Response {
    return PresignFileUpload200ResponseFromJSONTyped(json, false);
}

export function PresignFileUpload200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PresignFileUpload200Response {
    if (json == null) {
        return json;
    }
    return {
        ...
        'data': json['data'] == null ? undefined : PresignUploadResponseFromJSON(json['data']),
    };
}

export function PresignFileUpload200ResponseToJSON(json: any): PresignFileUpload200Response {
    return PresignFileUpload200ResponseToJSONTyped(json, false);
}

export function PresignFileUpload200ResponseToJSONTyped(value?: PresignFileUpload200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': PresignUploadResponseToJSON(value['data']),
    };
}
