...
export function ActionResultToJSON(json: any): ActionResult {
    return ActionResultToJSONTyped(json, false);
}

export function ActionResultToJSONTyped(value?: ActionResult | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
