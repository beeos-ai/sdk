 ...
 *
 * @export
 * @interface LongPressRequest
 */
export interface LongPressRequest {
    /**
     *
     * @type {number}
     * @memberof LongPressRequest
     */
    x: number;
    /**
     *
...
/**
 * Check if a given object implements the LongPressRequest interface.
 */
export function instanceOfLongPressRequest(value: object): value is LongPressRequest {
    if (!('x' in value) || value['x'] === undefined) return false;
    if (!('y' in value) || value['y'] === undefined) return false;
    return true;
}

export function LongPressRequestFromJSON(json: any): LongPressRequest {
    return LongPressRequestFromJSONTyped(json, false);
}

export function LongPressRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): LongPressRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function LongPressRequestToJSON(json: any): LongPressRequest {
    return LongPressRequestToJSONTyped(json, false);
}

export function LongPressRequestToJSONTyped(value?: LongPressRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
