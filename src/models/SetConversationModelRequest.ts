 ...
 * 
 * @export
 * @interface SetConversationModelRequest
 */
export interface SetConversationModelRequest {
     ...
     * 
     * @type {string}
     * @memberof SetConversationModelRequest
     */
    modelOverrideId: string;
}

/**
 * Check if a given object implements the SetConversationModelRequest interface.
 */
export function instanceOfSetConversationModelRequest(value: object): value is SetConversationModelRequest {
    if (!('modelOverrideId' in value) || value['modelOverrideId'] === undefined) return false;
    return true;
}

export function SetConversationModelRequestFromJSON(json: any): SetConversationModelRequest {
    return SetConversationModelRequestFromJSONTyped(json, false);
}

export function SetConversationModelRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): SetConversationModelRequest {
    if (json == null) {
        return json;
    }
    return {
            ...
            ...json,
        'modelOverrideId': json['modelOverrideId'],
    };
}

export function SetConversationModelRequestToJSON(json: any): SetConversationModelRequest {
    return SetConversationModelRequestToJSONTyped(json, false);
}

export function SetConversationModelRequestToJSONTyped(value?: SetConversationModelRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
