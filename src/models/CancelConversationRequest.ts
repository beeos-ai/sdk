 ...
 * 
 * @export
 * @interface CancelConversationRequest
 */
export interface CancelConversationRequest {
     ...
     * 
     * @type {string}
     * @memberof CancelConversationRequest
     */
...
/**
 * Check if a given object implements the CancelConversationRequest interface.
 */
export function instanceOfCancelConversationRequest(value: object): value is CancelConversationRequest {
    if (!('targetMessageId' in value) || value['targetMessageId'] === undefined) return false;
    return true;
}

export function CancelConversationRequestFromJSON(json: any): CancelConversationRequest {
    return CancelConversationRequestFromJSONTyped(json, false);
}

export function CancelConversationRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CancelConversationRequest {
    if (json == null) {
        return json;
    }
    return {
            ...
            ...json,
        'targetMessageId': json['target_message_id'],
        'reason': json['reason'] == null ? undefined : json['reason'],
    };
}

export function CancelConversationRequestToJSON(json: any): CancelConversationRequest {
    return CancelConversationRequestToJSONTyped(json, false);
}

export function CancelConversationRequestToJSONTyped(value?: CancelConversationRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
            ...
            ...value,
        'target_message_id': value['targetMessageId'],
        'reason': value['reason'],
    };
}
