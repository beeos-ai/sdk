...
import type { AgentCapabilitiesDTO } from './AgentCapabilitiesDTO';
import {
    AgentCapabilitiesDTOFromJSON,
    AgentCapabilitiesDTOFromJSONTyped,
    AgentCapabilitiesDTOToJSON,
    AgentCapabilitiesDTOToJSONTyped,
} from './AgentCapabilitiesDTO';
...
export interface AgentDTO {
     ...
     * @memberof AgentDTO
     */
    conversationTransport: AgentDTOConversationTransportEnum;
    /**
     * 
     * @type {Date}
     * @memberof AgentDTO
 ...
 * @export
 */
export const AgentDTOConversationTransportEnum = {
    Acp: 'acp',
    MessageService: 'message-service'
} as const;
export type AgentDTOConversationTransportEnum = typeof AgentDTOConversationTransportEnum[keyof typeof AgentDTOConversationTransportEnum];
...
export function instanceOfAgentDTO(value: object): value is AgentDTO {
    ...
    if (!('conversationTransport' in value) || value['conversationTransport'] === undefined) return false;
    return true;
}
...
export function AgentDTOFromJSONTyped(json: any, ignoreDiscriminator: boolean): AgentDTO {
    ...
    return {
        ...
        'defaultModelId': json['defaultModelId'] == null ? undefined : json['defaultModelId'],
        'visibility': json['visibility'],
        'capabilities': AgentCapabilitiesDTOFromJSON(json['capabilities']),
        'conversationTransport': json['conversationTransport'],
...
export function AgentDTOToJSONTyped(value?: AgentDTO | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'capabilities': AgentCapabilitiesDTOToJSON(value['capabilities']),
        'conversationTransport': value['conversationTransport'],
