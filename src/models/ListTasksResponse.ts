...
import type { ListTasksResponseAllOfData } from './ListTasksResponseAllOfData';
import {
    ListTasksResponseAllOfDataFromJSON,
    ListTasksResponseAllOfDataFromJSONTyped,
    ListTasksResponseAllOfDataToJSON,
    ListTasksResponseAllOfDataToJSONTyped,
} from './ListTasksResponseAllOfData';
...
export interface ListTasksResponse {
     ...
     */
    success: ListTasksResponseSuccessEnum;
    /**
     * 
     * @type {ListTasksResponseAllOfData}
     * @memberof ListTasksResponse
     */
 ...
 * @export
 */
export const ListTasksResponseSuccessEnum = {
    True: true
} as const;
export type ListTasksResponseSuccessEnum = typeof ListTasksResponseSuccessEnum[keyof typeof ListTasksResponseSuccessEnum];
...
export function ListTasksResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListTasksResponse {
    ...
    return {
        ...
        'data': ListTasksResponseAllOfDataFromJSON(json['data']),
    };
}

export function ListTasksResponseToJSON(json: any): ListTasksResponse {
    return ListTasksResponseToJSONTyped(json, false);
}

export function ListTasksResponseToJSONTyped(value?: ListTasksResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': ListTasksResponseAllOfDataToJSON(value['data']),
    };
}
