...
import type { CancelConversation202ResponseData } from './CancelConversation202ResponseData';
import {
    CancelConversation202ResponseDataFromJSON,
    CancelConversation202ResponseDataFromJSONTyped,
    CancelConversation202ResponseDataToJSON,
    CancelConversation202ResponseDataToJSONTyped,
} from './CancelConversation202ResponseData';

/**
 * 
 * @export
 * @interface CancelConversation202Response
 */
export interface CancelConversation202Response {
    [key: string]: any | any;
    /**
     * 
     * @type {boolean}
     * @memberof CancelConversation202Response
     */
    success: boolean;
    /**
     * 
     * @type {CancelConversation202ResponseData}
     * @memberof CancelConversation202Response
     */
...
/**
 * Check if a given object implements the CancelConversation202Response interface.
 */
export function instanceOfCancelConversation202Response(value: object): value is CancelConversation202Response {
    if (!('success' in value) || value['success'] === undefined) return false;
    if (!('data' in value) || value['data'] === undefined) return false;
    return true;
}

export function CancelConversation202ResponseFromJSON(json: any): CancelConversation202Response {
    return CancelConversation202ResponseFromJSONTyped(json, false);
}

export function CancelConversation202ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CancelConversation202Response {
    if (json == null) {
        return json;
    }
    return {
        ...
        'data': CancelConversation202ResponseDataFromJSON(json['data']),
    };
}

export function CancelConversation202ResponseToJSON(json: any): CancelConversation202Response {
    return CancelConversation202ResponseToJSONTyped(json, false);
}

export function CancelConversation202ResponseToJSONTyped(value?: CancelConversation202Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': CancelConversation202ResponseDataToJSON(value['data']),
    };
}
