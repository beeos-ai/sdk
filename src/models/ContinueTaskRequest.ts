...
/**
 * Check if a given object implements the ContinueTaskRequest interface.
 */
export function instanceOfContinueTaskRequest(value: object): value is ContinueTaskRequest {
    return true;
}

export function ContinueTaskRequestFromJSON(json: any): ContinueTaskRequest {
    return ContinueTaskRequestFromJSONTyped(json, false);
}

export function ContinueTaskRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ContinueTaskRequest {
    if (json == null) {
        return json;
    }
    return {
        ...
        'authGrant': json['auth_grant'] == null ? undefined : json['auth_grant'],
    };
}

export function ContinueTaskRequestToJSON(json: any): ContinueTaskRequest {
    return ContinueTaskRequestToJSONTyped(json, false);
}

export function ContinueTaskRequestToJSONTyped(value?: ContinueTaskRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
