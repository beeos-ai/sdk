 ...
 * 
 * @export
 * @interface AgentCapabilitiesDTO
 */
export interface AgentCapabilitiesDTO {
    /**
     * 
     * @type {boolean}
     * @memberof AgentCapabilitiesDTO
     */
...
/**
 * Check if a given object implements the AgentCapabilitiesDTO interface.
 */
export function instanceOfAgentCapabilitiesDTO(value: object): value is AgentCapabilitiesDTO {
    if (!('multipleConversations' in value) || value['multipleConversations'] === undefined) return false;
    if (!('loadConversation' in value) || value['loadConversation'] === undefined) return false;
    if (!('createConversation' in value) || value['createConversation'] === undefined) return false;
    if (!('canvas' in value) || value['canvas'] === undefined) return false;
    if (!('terminal' in value) || value['terminal'] === undefined) return false;
    if (!('webSsh' in value) || value['webSsh'] === undefined) return false;
    if (!('fileSystem' in value) || value['fileSystem'] === undefined) return false;
    if (!('image' in value) || value['image'] === undefined) return false;
    if (!('audio' in value) || value['audio'] === undefined) return false;
    if (!('mcp' in value) || value['mcp'] === undefined) return false;
    ...
    if (!('a2a' in value) || value['a2a'] === undefined) return false;
    if (!('extendedAgentCard' in value) || value['extendedAgentCard'] === undefined) return false;
    if (!('modelsList' in value) || value['modelsList'] === undefined) return false;
    if (!('modelsSet' in value) || value['modelsSet'] === undefined) return false;
    if (!('skillsList' in value) || value['skillsList'] === undefined) return false;
    if (!('skillsInstall' in value) || value['skillsInstall'] === undefined) return false;
    if (!('skillsUninstall' in value) || value['skillsUninstall'] === undefined) return false;
    if (!('skillsUpdate' in value) || value['skillsUpdate'] === undefined) return false;
    return true;
}

export function AgentCapabilitiesDTOFromJSON(json: any): AgentCapabilitiesDTO {
    return AgentCapabilitiesDTOFromJSONTyped(json, false);
}

export function AgentCapabilitiesDTOFromJSONTyped(json: any, ignoreDiscriminator: boolean): AgentCapabilitiesDTO {
    if (json == null) {
        return json;
    }
    return {
        
        'multipleConversations': json['multipleConversations'],
        'loadConversation': json['loadConversation'],
        'createConversation': json['createConversation'],
        'canvas': json['canvas'],
        ...
        'a2a': json['a2a'],
        'extendedAgentCard': json['extendedAgentCard'],
        'modelsList': json['modelsList'],
        'modelsSet': json['modelsSet'],
        'skillsList': json['skillsList'],
        'skillsInstall': json['skillsInstall'],
        'skillsUninstall': json['skillsUninstall'],
        'skillsUpdate': json['skillsUpdate'],
    };
}

export function AgentCapabilitiesDTOToJSON(json: any): AgentCapabilitiesDTO {
    return AgentCapabilitiesDTOToJSONTyped(json, false);
}

export function AgentCapabilitiesDTOToJSONTyped(value?: AgentCapabilitiesDTO | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'multipleConversations': value['multipleConversations'],
        ...
        'modelsList': value['modelsList'],
        'modelsSet': value['modelsSet'],
        'skillsList': value['skillsList'],
        'skillsInstall': value['skillsInstall'],
        'skillsUninstall': value['skillsUninstall'],
        'skillsUpdate': value['skillsUpdate'],
    };
}
