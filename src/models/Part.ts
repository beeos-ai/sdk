...
import { PartCustom, PartCustomFromJSONTyped, PartCustomToJSON } from './PartCustom';
import { PartFile, PartFileFromJSONTyped, PartFileToJSON } from './PartFile';
import { PartSource, PartSourceFromJSONTyped, PartSourceToJSON } from './PartSource';
import { PartThinking, PartThinkingFromJSONTyped, PartThinkingToJSON } from './PartThinking';
import { PartToolResult, PartToolResultFromJSONTyped, PartToolResultToJSON } from './PartToolResult';
import { PartToolUse, PartToolUseFromJSONTyped, PartToolUseToJSON } from './PartToolUse';
 ...
 * @export
 */
export type Part = { type: 'custom' } & PartCustom | { type: 'file' } & PartFile | { type: 'source' } & PartSource | { type: 'thinking' } & PartThinking | { type: 'tool_result' } & PartToolResult | { type: 'tool_use' } & PartToolUse;
...
export function PartFromJSONTyped(json: any, ignoreDiscriminator: boolean): Part {
    ...
    switch (json['type']) {
        case 'custom':
            return Object.assign({}, PartCustomFromJSONTyped(json, true), { type: 'custom' } as const);
        case 'file':
            return Object.assign({}, PartFileFromJSONTyped(json, true), { type: 'file' } as const);
        case 'source':
            return Object.assign({}, PartSourceFromJSONTyped(json, true), { type: 'source' } as const);
        case 'thinking':
            return Object.assign({}, PartThinkingFromJSONTyped(json, true), { type: 'thinking' } as const);
        case 'tool_result':
            return Object.assign({}, PartToolResultFromJSONTyped(json, true), { type: 'tool_result' } as const);
        case 'tool_use':
            return Object.assign({}, PartToolUseFromJSONTyped(json, true), { type: 'tool_use' } as const);
        default:
            return json;
    }
}
...
export function PartToJSONTyped(value?: Part | null, ignoreDiscriminator: boolean = false): any {
    ...
    switch (value['type']) {
        case 'custom':
            return Object.assign({}, PartCustomToJSON(value), { type: 'custom' } as const);
        case 'file':
            return Object.assign({}, PartFileToJSON(value), { type: 'file' } as const);
        case 'source':
            return Object.assign({}, PartSourceToJSON(value), { type: 'source' } as const);
        case 'thinking':
            return Object.assign({}, PartThinkingToJSON(value), { type: 'thinking' } as const);
        case 'tool_result':
            return Object.assign({}, PartToolResultToJSON(value), { type: 'tool_result' } as const);
        case 'tool_use':
            return Object.assign({}, PartToolUseToJSON(value), { type: 'tool_use' } as const);
        default:
            return value;
    }
}
