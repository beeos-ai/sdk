...
/**
 * Check if a given object implements the OpenAppRequest interface.
 */
export function instanceOfOpenAppRequest(value: object): value is OpenAppRequest {
    if (!('app' in value) || value['app'] === undefined) return false;
    return true;
}

export function OpenAppRequestFromJSON(json: any): OpenAppRequest {
    return OpenAppRequestFromJSONTyped(json, false);
}

export function OpenAppRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): OpenAppRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function OpenAppRequestToJSON(json: any): OpenAppRequest {
    return OpenAppRequestToJSONTyped(json, false);
}

export function OpenAppRequestToJSONTyped(value?: OpenAppRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
