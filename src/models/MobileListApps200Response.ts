 ...
 *
 * @export
 * @interface MobileListApps200Response
 */
export interface MobileListApps200Response {
    /**
     *
     * @type {boolean}
     * @memberof MobileListApps200Response
     */
    success: MobileListApps200ResponseSuccessEnum;
    /**
     *
     * @type {AppListResult}
     * @memberof MobileListApps200Response
 ...
 * @export
 */
export const MobileListApps200ResponseSuccessEnum = {
    True: true
} as const;
export type MobileListApps200ResponseSuccessEnum = typeof MobileListApps200ResponseSuccessEnum[keyof typeof MobileListApps200ResponseSuccessEnum];


/**
 * Check if a given object implements the MobileListApps200Response interface.
 */
export function instanceOfMobileListApps200Response(value: object): value is MobileListApps200Response {
    if (!('success' in value) || value['success'] === undefined) return false;
    return true;
}

export function MobileListApps200ResponseFromJSON(json: any): MobileListApps200Response {
    return MobileListApps200ResponseFromJSONTyped(json, false);
}

export function MobileListApps200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): MobileListApps200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function MobileListApps200ResponseToJSON(json: any): MobileListApps200Response {
    return MobileListApps200ResponseToJSONTyped(json, false);
}

export function MobileListApps200ResponseToJSONTyped(value?: MobileListApps200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
