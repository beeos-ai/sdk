 ...
 * 
 * @export
 * @interface ConversationResponseAllOfData
 */
export interface ConversationResponseAllOfData {
    /**
     * 
     * @type {string}
     * @memberof ConversationResponseAllOfData
     */
     ...
     * @memberof ConversationResponseAllOfData
     */
    state: ConversationResponseAllOfDataStateEnum;
    /**
     * 
    ...
    closedAt?: Date;
    /**
     * Session model override projected by Message Service after
     * `PUT …/conversations/{id}/model` (session/set_model). Absent
     * when the conversation uses the agent/instance default.
     * 
     * @type {string}
     * @memberof ConversationResponseAllOfData
     */
    ...
    /**
     * Resolved effective model when Core/MS projects one alongside
     * the override. Clients may fall back to modelOverrideId when
 ...
 * @export
 */
export const ConversationResponseAllOfDataStateEnum = {
    Active: 'active',
    Closed: 'closed'
} as const;
export type ConversationResponseAllOfDataStateEnum = typeof ConversationResponseAllOfDataStateEnum[keyof typeof ConversationResponseAllOfDataStateEnum];


/**
 * Check if a given object implements the ConversationResponseAllOfData interface.
 */
export function instanceOfConversationResponseAllOfData(value: object): value is ConversationResponseAllOfData {
...
export function ConversationResponseAllOfDataFromJSON(json: any): ConversationResponseAllOfData {
    return ConversationResponseAllOfDataFromJSONTyped(json, false);
}

export function ConversationResponseAllOfDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConversationResponseAllOfData {
    if (json == null) {
        return json;
    }
    return {
        ...
        'modelOverrideId': json['modelOverrideId'] == null ? undefined : json['modelOverrideId'],
        'effectiveModelId': json['effectiveModelId'] == null ? undefined : json['effectiveModelId'],
    };
}

export function ConversationResponseAllOfDataToJSON(json: any): ConversationResponseAllOfData {
    return ConversationResponseAllOfDataToJSONTyped(json, false);
}

export function ConversationResponseAllOfDataToJSONTyped(value?: ConversationResponseAllOfData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'modelOverrideId': value['modelOverrideId'],
