...
import type { TaskCreatedResponseAllOfData } from './TaskCreatedResponseAllOfData';
import {
    TaskCreatedResponseAllOfDataFromJSON,
    TaskCreatedResponseAllOfDataFromJSONTyped,
    TaskCreatedResponseAllOfDataToJSON,
    TaskCreatedResponseAllOfDataToJSONTyped,
} from './TaskCreatedResponseAllOfData';
...
export interface TaskCreatedResponse {
     ...
     * 
     * @type {boolean}
     * @memberof TaskCreatedResponse
     */
    success: TaskCreatedResponseSuccessEnum;
    /**
     * 
     * @type {TaskCreatedResponseAllOfData}
     * @memberof TaskCreatedResponse
     */
 ...
 * @export
 */
export const TaskCreatedResponseSuccessEnum = {
    True: true
} as const;
export type TaskCreatedResponseSuccessEnum = typeof TaskCreatedResponseSuccessEnum[keyof typeof TaskCreatedResponseSuccessEnum];


/**
 * Check if a given object implements the TaskCreatedResponse interface.
 */
export function instanceOfTaskCreatedResponse(value: object): value is TaskCreatedResponse {
    if (!('success' in value) || value['success'] === undefined) return false;
    if (!('data' in value) || value['data'] === undefined) return false;
    return true;
}

export function TaskCreatedResponseFromJSON(json: any): TaskCreatedResponse {
    return TaskCreatedResponseFromJSONTyped(json, false);
}

export function TaskCreatedResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): TaskCreatedResponse {
    if (json == null) {
        return json;
    }
    return {
        ...
        'data': TaskCreatedResponseAllOfDataFromJSON(json['data']),
    };
}

export function TaskCreatedResponseToJSON(json: any): TaskCreatedResponse {
    return TaskCreatedResponseToJSONTyped(json, false);
}

export function TaskCreatedResponseToJSONTyped(value?: TaskCreatedResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': TaskCreatedResponseAllOfDataToJSON(value['data']),
    };
}
