 ...
 * 
 * @export
 * @interface RuntimeJSONRPCBusinessErrorError
 */
export interface RuntimeJSONRPCBusinessErrorError {
    [key: string]: any | any;
    /**
     * 
     * @type {number}
     * @memberof RuntimeJSONRPCBusinessErrorError
     */
    code: number;
    /**
     * 
     ...
     * @memberof RuntimeJSONRPCBusinessErrorError
     */
    message: RuntimeJSONRPCBusinessErrorErrorMessageEnum;
    /**
     * 
     * @type {any}
     * @memberof RuntimeJSONRPCBusinessErrorError
 ...
 * @export
 */
export const RuntimeJSONRPCBusinessErrorErrorMessageEnum = {
...
export type RuntimeJSONRPCBusinessErrorErrorMessageEnum = typeof RuntimeJSONRPCBusinessErrorErrorMessageEnum[keyof typeof RuntimeJSONRPCBusinessErrorErrorMessageEnum];


/**
 * Check if a given object implements the RuntimeJSONRPCBusinessErrorError interface.
 */
export function instanceOfRuntimeJSONRPCBusinessErrorError(value: object): value is RuntimeJSONRPCBusinessErrorError {
    if (!('code' in value) || value['code'] === undefined) return false;
    if (!('message' in value) || value['message'] === undefined) return false;
    return true;
}

export function RuntimeJSONRPCBusinessErrorErrorFromJSON(json: any): RuntimeJSONRPCBusinessErrorError {
    return RuntimeJSONRPCBusinessErrorErrorFromJSONTyped(json, false);
}

export function RuntimeJSONRPCBusinessErrorErrorFromJSONTyped(json: any, ignoreDiscriminator: boolean): RuntimeJSONRPCBusinessErrorError {
    if (json == null) {
        return json;
    }
    return {
...
export function RuntimeJSONRPCBusinessErrorErrorToJSON(json: any): RuntimeJSONRPCBusinessErrorError {
    return RuntimeJSONRPCBusinessErrorErrorToJSONTyped(json, false);
}

export function RuntimeJSONRPCBusinessErrorErrorToJSONTyped(value?: RuntimeJSONRPCBusinessErrorError | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
