...
import {
    DeviceInfoDTOFromJSON,
    DeviceInfoDTOFromJSONTyped,
    DeviceInfoDTOToJSON,
    DeviceInfoDTOToJSONTyped,
} from './DeviceInfoDTO';

/**
 * 
 * @export
 * @interface GetDeviceInfo200Response
 */
export interface GetDeviceInfo200Response {
    /**
     * 
     * @type {boolean}
     * @memberof GetDeviceInfo200Response
     */
    success: GetDeviceInfo200ResponseSuccessEnum;
    /**
     * 
     * @type {DeviceInfoDTO}
     * @memberof GetDeviceInfo200Response
 ...
 * @export
 */
export const GetDeviceInfo200ResponseSuccessEnum = {
    True: true
} as const;
export type GetDeviceInfo200ResponseSuccessEnum = typeof GetDeviceInfo200ResponseSuccessEnum[keyof typeof GetDeviceInfo200ResponseSuccessEnum];


/**
 * Check if a given object implements the GetDeviceInfo200Response interface.
 */
export function instanceOfGetDeviceInfo200Response(value: object): value is GetDeviceInfo200Response {
    if (!('success' in value) || value['success'] === undefined) return false;
    return true;
}

export function GetDeviceInfo200ResponseFromJSON(json: any): GetDeviceInfo200Response {
    return GetDeviceInfo200ResponseFromJSONTyped(json, false);
}

export function GetDeviceInfo200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetDeviceInfo200Response {
    if (json == null) {
        return json;
    }
    return {
        ...
        'data': json['data'] == null ? undefined : DeviceInfoDTOFromJSON(json['data']),
    };
}

export function GetDeviceInfo200ResponseToJSON(json: any): GetDeviceInfo200Response {
    return GetDeviceInfo200ResponseToJSONTyped(json, false);
}

export function GetDeviceInfo200ResponseToJSONTyped(value?: GetDeviceInfo200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': DeviceInfoDTOToJSON(value['data']),
    };
}
