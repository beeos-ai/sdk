 ...
 * @export
 */
export const PartSourceTypeEnum = {
    Source: 'source'
} as const;
export type PartSourceTypeEnum = typeof PartSourceTypeEnum[keyof typeof PartSourceTypeEnum];


/**
 * Check if a given object implements the PartSource interface.
 */
export function instanceOfPartSource(value: object): value is PartSource {
    if (!('type' in value) || value['type'] === undefined) return false;
    if (!('url' in value) || value['url'] === undefined) return false;
    return true;
}

export function PartSourceFromJSON(json: any): PartSource {
    return PartSourceFromJSONTyped(json, false);
}

export function PartSourceFromJSONTyped(json: any, ignoreDiscriminator: boolean): PartSource {
    if (json == null) {
        return json;
    }
    return {
...
export function PartSourceToJSON(json: any): PartSource {
    return PartSourceToJSONTyped(json, false);
}

export function PartSourceToJSONTyped(value?: PartSource | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
