...
import {
    ...
    ErrorResponseToJSON,
    GetDeviceInfo200ResponseFromJSON,
    GetDeviceInfo200ResponseToJSON,
...
export class InstancesApi extends runtime.BaseAPI {
     ...
     */
    async getDeviceInfoRaw(requestParameters: GetDeviceInfoRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetDeviceInfo200Response>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling getDeviceInfo().'
            );
        }
        ...
        let urlPath = `/api/v1/instances/{id}/device/info`;
        urlPath = urlPath.replace(`{${"id"}}`, encodeURIComponent(String(requestParameters['id'])));
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => GetDeviceInfo200ResponseFromJSON(jsonValue));
    }
     ...
     * BYOD device registration / static metadata.
     */
    async getDeviceInfo(requestParameters: GetDeviceInfoRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetDeviceInfo200Response> {
